...
/** 
* @ClassName:  ScRoadnamePosition 
* @author code generator
* @date 2017-03-23 07:07:15 
* @Description: TODO
*/
public class ScRoadnamePosition  {
	private Integer id ;
	private String name ;
	private Integer regionFlag ;
	private String langCode ;
	
	public ScRoadnamePosition (){
	}
	
	public ScRoadnamePosition (Integer id ,String name,Integer regionFlag,String langCode){
		this.id=id ;
		this.name=name ;
	...
	public String toString() {
		return "ScRoadnamePosition [id=" + id +",name="+name+",regionFlag="+regionFlag+",langCode="+langCode+"]";
	}
	...
	public boolean equals(Object obj) {
		...
		if (getClass() != obj.getClass())
			return false;
		ScRoadnamePosition other = (ScRoadnamePosition) obj;
		if (id == null) {
			if (other.id != null)
				return false;
