...
public class ZoneFaceTopoOperator implements IOperator {
	...
	public void updateRow() throws Exception {
		StringBuilder sb = new StringBuilder("update " + zoneFaceTopo.tableName() + " set u_record=3,");

		PreparedStatement pstmt = null;

		try {

			Set<Entry<String, Object>> set = zoneFaceTopo.changedFields().entrySet();
	...
	public void deleteRow2Sql(Statement stmt) throws Exception {
		String sql = "update " + zoneFaceTopo.tableName() + " set u_record=2 where row_id=hextoraw('" + zoneFaceTopo.rowId()
				+ "')";
