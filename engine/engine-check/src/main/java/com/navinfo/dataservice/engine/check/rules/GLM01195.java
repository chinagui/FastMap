...
public class GLM01195 extends baseRule {
    ...
    private void checkWithRdLink(RdLink rdLink, List<Integer> linkPidList) throws Exception {
        ...
        // log.info("GLM01195:[pidStr=" + pidStr + "]");
        String sql = "SELECT COUNT(COUNT(0)) FROM RD_LINK_SPEEDLIMIT L WHERE L.LINK_PID IN (" + pidStr + ") AND " +
                "L.U_RECORD != 2 GROUP BY L.SPEED_TYPE, L.SPEED_CLASS";
        // log.info("GLM01195:[sql=" + sql + "]");
