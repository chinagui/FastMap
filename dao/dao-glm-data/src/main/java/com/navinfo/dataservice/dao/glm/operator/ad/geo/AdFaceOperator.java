...
public class AdFaceOperator extends AbstractOperator {

	private static Logger logger = Logger.getLogger(AdFaceOperator.class);
	...
	public void insertRow2Sql(Statement stmt) throws Exception {
		...
		sb.append("(face_pid, region_id, geometry, area, perimeter, mesh_id, "
				+ "edit_flag, u_record, row_id) values (");
	...
	public void updateRow2Sql(Statement stmt)
			throws Exception {
		StringBuilder sb = new StringBuilder("update " + adFace.tableName()
				+ " set u_record=3,");
	...
	public void deleteRow2Sql(Statement stmt) throws Exception {
		String sql = "update " + adFace.tableName()
				+ " set u_record=2 where face_pid=" + adFace.getPid();
