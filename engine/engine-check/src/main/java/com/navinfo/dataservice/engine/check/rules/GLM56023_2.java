...
/**
 * @ClassName GLM56023_2
 * @author Han Shaoming
 * @date 2017年1月5日 上午10:33:24
 * @Description TODO
 * 当“内业作业状态”≠2时，做如下检查：当点限速限速条件不为“无”时，限速类型必须为“特定条件”，否则报log
 * 点限速限速条件	服务端后检查
 * 点限速限速类型	服务端后检查
 */
public class GLM56023_2 extends baseRule {
	...
	private boolean check(int pid) throws Exception {
		...
		log.info("后检查GLM56023_2--sql:" + sql);
