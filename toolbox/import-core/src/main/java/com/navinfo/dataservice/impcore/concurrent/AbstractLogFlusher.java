...
/**
 * 
 * @ClassName: AbstractLogFlusher
 * @author xiaoxiaowen4127
 * @date 2017年9月18日
 * @Description: AbstractLogFlusher.java
 */
public abstract class AbstractLogFlusher implements Runnable{
	...
	public AbstractLogFlusher(ThreadSharedObjectExtResult sharedResults){
		run = new QueryRunner();
	}
