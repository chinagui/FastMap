...
public class PoiCollectExpectMain {
	private Logger log = LogManager.getLogger(PoiCollectExpectMain.class);

	private static CountDownLatch countDownLatch = null;

	public static final String col_name_block = "fm_stat_expect_collect_poi_block";

	private String db_name;
	private String stat_date;
	private String stat_time;

	public PoiCollectExpectMain(String dbn, String stat_time) {
		this.db_name = dbn;
	...
	public void runStat() {
		...
		try {
			...
			executorService.submit(new PoiCollectExpectStat(countDownLatch,
