...
//			Map<String, Long> parentFidChildPid) {
...
//					//原始父与新父一致，不做任何操作
//					if(childPidOrigionParentPid.containsKey(childPid)&&childPidOrigionParentPid.get(childPid)==parentPid){
//						log.info("原始父与新父一致，不做任何操作，childPid:" + childPid + ";OrigionParentPid:" + childPidOrigionParentPid.get(childPid)
//						 + ";parentPid:" + parentPid);
//						continue;
//					}
//					//解除原始父子关系
