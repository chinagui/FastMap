...
public class DbService {
	...
	public DbInfo createDb(String userName,String dbName,String bizType,String descp,String strategyType,Map<String,String> strategyParamMap)throws DataHubException{
		return createDb(dbName, bizType, descp, null, null,null);
	}
	public DbInfo createDb(String userName,String dbName,String bizType,String descp,String strategyType,Map<String,String> strategyParamMap,String gdbVersion)throws DataHubException{
		DbInfo db = null;
