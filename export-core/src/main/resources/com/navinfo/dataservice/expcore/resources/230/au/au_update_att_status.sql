...
UPDATE AU_IX_POI SET ATT_TASK_ID=${taskId},ATT_OPRSTATUS=${dmsStatus} where AUDATA_ID IN (SELECT PID FROM TEMP_IX_POI) AND ATT_OPRSTATUS = 0 AND STATE <>0;
UPDATE AU_IX_POINTADDRESS SET ATT_TASK_ID=${taskId},ATT_OPRSTATUS=${dmsStatus} where AUDATA_ID IN (SELECT PID FROM TEMP_IX_POINTADDRESS) AND ATT_OPRSTATUS = 0 AND STATE <>0;
...
UPDATE AU_PT_POI SET ATT_TASK_ID=${taskId},ATT_OPRSTATUS=${dmsStatus} where AUDATA_ID IN (SELECT PID FROM TEMP_PT_POI) AND ATT_OPRSTATUS = 0 AND STATE <>0;
UPDATE AU_PT_PLATFORM SET ATT_TASK_ID=${taskId},ATT_OPRSTATUS=${dmsStatus} where AUDATA_ID IN (SELECT PID FROM TEMP_PT_PLATFORM) AND ATT_OPRSTATUS = 0 AND STATE <>0;
...
UPDATE AU_PT_STRAND SET ATT_TASK_ID=${taskId},ATT_OPRSTATUS=${dmsStatus} where AUDATA_ID IN (SELECT PID FROM TEMP_PT_STRAND) AND ATT_OPRSTATUS = 0 AND STATE <>0;
