...
public class AdLinkMeshSelector implements ISelector {
	
	private static Logger logger = Logger.getLogger(AdFaceSelector.class);

	private Connection conn;
	
	public AdLinkMeshSelector(Connection conn) {
		super();
		this.conn = conn;
	}
	...
	public List<IRow> loadRowsByParentId(int id, boolean isLock) throws Exception {
		...
		String sql = "select * from ad_link_mesh where link_pid=:1 and u_record!=:2";
