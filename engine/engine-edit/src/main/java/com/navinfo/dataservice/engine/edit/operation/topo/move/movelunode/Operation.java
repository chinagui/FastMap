...
public class Operation implements IOperation {
    ...
    private void updateNodeGeometry(Result result) throws Exception {
        ...
        // 组装打断线的参数
        // 保证是同一个连接
        com.navinfo.dataservice.engine.edit.operation.obj.lunode.update.Command updatecommand = new com.navinfo.dataservice.engine.edit.operation.obj.lunode.update.Command(updateNodeJson, command.getRequester());
