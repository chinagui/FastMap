...
import com.navinfo.dataservice.engine.edit.utils.CalPassLinkUtils;
...
public class serchConditionTest extends InitApplication {
    ...
    public void getByCondition() {
        ...
        try {
            ...
            String parameter = "{\"type\":\"RDLANEVIA\",\"data\":{\"inLinkPid\":690369,\"nodePid\":791323,\"outLinkPid\":507000282},\"dbId\":13}";
...
//			jsonMeshId.add();
    ...
    public void SearchAllObject12() {
        ...
        try {
            ...
            String parameter = "{\"uuid\":\"63ee8766-4c01-4566-8795-136843162a33\",\"dbId\":13,\"gridIds\":[59567503,59567202,59567203,59567212,60555713,59567213,59567332],\"meshIds\":[],\"pageNum\":1,\"pageSize\":20,\"mainTableName\":\"RD_BRANCH\",\"searchTableName\":\"RD_BRANCH_REALIMAGE\",\"conditions\":[{\"fieldName\":\"BRANCH_PID\",\"operator\":\"=\",\"fieldType\":\"Integer\",\"value\":408000010,\"$$hashKey\":\"object:943\"}]}";
    ...
    @Test
    public void calPassLinks1() {
        Connection conn;
        try {
            int inLinkPid = 30415406;

            int nodePid = 23915321;

            int outLinkPid = 30415412;

            conn = DBConnector.getInstance().getConnectionById(13);

            CalLinkOperateUtils p = new CalLinkOperateUtils(conn);

            List<Integer> passLinkPids = p.calViaLinks(conn,inLinkPid,
                    nodePid, outLinkPid);

            System.out.println(passLinkPids);
