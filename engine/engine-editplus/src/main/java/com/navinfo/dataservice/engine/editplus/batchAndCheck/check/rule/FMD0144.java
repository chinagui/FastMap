...
/**
 * 	FM-D01-44	官方原始英文名错误检查		DHM	
	检查条件：非删除POI对象
	检查原则：POI官方原始英文名称中含有配置表“POI名称相关检查配置表（SC_POINT_NAMECK）”中的“TYPE=9”的“PRE_KEY”的POI英文名称报出：英文名中含有：xxxx
	检查名称：官方原始英文名称（type={2}，class=1，langCode=ENG）
 * @author sunjiawei
 */
public class FMD0144 extends BasicCheckRule {
	...
	public void runCheck(BasicObj obj) throws Exception {
		if(obj.objName().equals(ObjectName.IX_POI)){
			...
			for(IxPoiName nameTmp:names){
				if(nameTmp.getNameType()==2&&nameTmp.getNameClass()==1&&nameTmp.isEng()){
