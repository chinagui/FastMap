...
* @date 2017-03-23 07:06:06 
* @Description: TODO
*/
public class ScRoadnameInfix  {
	private Integer id ;
	private String name ;
	private String py ;
	...
	public ScRoadnameInfix (){
	}
	
	public ScRoadnameInfix (Integer id ,String name,String py,String englishname,Integer regionFlag,String langCode){
		this.id=id ;
		this.name=name ;
		this.py=py ;
	...
	public String toString() {
		return "ScRoadnameInfix [id=" + id +",name="+name+",py="+py+",englishname="+englishname+",regionFlag="+regionFlag+",langCode="+langCode+"]";
	}
	...
	public boolean equals(Object obj) {
		...
		if (getClass() != obj.getClass())
			return false;
		ScRoadnameInfix other = (ScRoadnameInfix) obj;
		if (id == null) {
			if (other.id != null)
				return false;
