...
public class ZoneFaceOperator extends AbstractOperator {
	...
	public void insertRow2Sql(Statement stmt) throws Exception {
		...
		for (IRow r : zoneFace.getFaceTopos()) {
			ZoneFaceTopoOperator ap = new ZoneFaceTopoOperator(conn,
					(ZoneFaceTopo) r);
	...
	public void updateRow2Sql( Statement stmt)
			throws Exception {
		StringBuilder sb = new StringBuilder("update " + zoneFace.tableName()
				+ " set u_record=3,");
	...
	public void deleteRow2Sql(Statement stmt) throws Exception {
		String sql = "update " + zoneFace.tableName()
				+ " set u_record=2 where face_pid=" + zoneFace.getPid();
