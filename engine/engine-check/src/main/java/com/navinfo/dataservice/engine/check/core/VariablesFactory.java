...
public class VariablesFactory {
    ...
    public static Set<String> getRdLinkPid(IRow data) {
        ...
        if (data instanceof RdLinkLimit) {
            rdLinkSet.add(String.valueOf(((RdLinkLimit) data).getLinkPid()));
        }
        if (data instanceof RdLinkSpeedlimit) {
            rdLinkSet.add(String.valueOf(((RdLinkSpeedlimit) data).getLinkPid()));
        }
        return rdLinkSet;
    }
