...
public class Operation implements IOperation {
	...
	private void updateNodeGeometry(Result result) throws Exception {
		...
		// 组装打断线的参数
		// 保证是同一个连接
		com.navinfo.dataservice.engine.edit.edit.operation.obj.lunode.update.Command updatecommand = new com.navinfo.dataservice.engine.edit.edit.operation.obj.lunode.update.Command(
				updateNodeJson, command.getRequester());
		com.navinfo.dataservice.engine.edit.edit.operation.obj.lunode.update.Process process = new com.navinfo.dataservice.engine.edit.edit.operation.obj.lunode.update.Process(
		...
		if (command.getFaces() != null && command.getFaces().size() > 0) {
			...
			for (LuFace face : command.getFaces()) {
				...
				if (flag) {
					...
					com.navinfo.dataservice.engine.edit.edit.operation.obj.luface.create.Operation opFace = new com.navinfo.dataservice.engine.edit.edit.operation.obj.luface.create.Operation(
							result);
