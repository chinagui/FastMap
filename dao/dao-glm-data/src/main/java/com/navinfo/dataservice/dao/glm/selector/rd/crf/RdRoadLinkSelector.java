...
public class RdRoadLinkSelector extends AbstractSelector {
	...
	public List<RdRoadLink> loadByLinks(List<Integer> linkPids, boolean isLock)
			throws Exception {
	 ...
	 * @throws Exception
	 */
	private List<RdRoadLink> loadByLinkPids(List<Integer> linkPids,
		...
		try {
			...
			StringBuilder sb = new StringBuilder(
					"select * from rd_road_link where link_pid in ("
