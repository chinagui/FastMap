...
public class RdGscTest extends InitApplication{
	...
	{
		String parameter = "{\"command\":\"CREATE\",\"type\":\"RDGSC\",\"dbId\":42,\"data\":{\"geometry\":{\"type\":\"Polygon\",\"coordinates\":[[[116.47743701934816,40.01310853533514],[116.47743701934816,40.01331396470674],[116.47776961326599,40.01331396470674],[116.47776961326599,40.01310853533514],[116.47743701934816,40.01310853533514]]]},\"linkObjs\":[{\"pid\":\"100005910\",\"level_index\":0,\"type\":\"RWLINK\"},{\"pid\":\"100005912\",\"level_index\":1,\"type\":\"RWLINK\"}]}}";
		Transaction t = new Transaction(parameter);
		try {
			String msg = t.run();
			System.out.println(msg);
	...
	{
		String parameter = "{\"command\":\"CREATE\",\"dbId\":42,\"data\":{\"eNodePid\":0,\"sNodePid\":0,\"geometry\":{\"type\":\"LineString\",\"coordinates\":[[116.47676110267639,40.01131305630903],[116.47781252861023,40.01052418102419]]},\"catchLinks\":[]},\"type\":\"RWLINK\"}";
		Transaction t = new Transaction(parameter);
		try {
			String msg = t.run();
			System.out.println(msg);
