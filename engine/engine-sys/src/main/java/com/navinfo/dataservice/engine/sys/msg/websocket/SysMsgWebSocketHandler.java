...
public class SysMsgWebSocketHandler extends TextWebSocketHandler {
	...
	static {
		...
		log = LoggerRepos.getLogger(SysMsgWebSocketHandler.class);
	}
	private volatile static SysMsgWebSocketHandler instance;
	public static SysMsgWebSocketHandler getInstance(){
		if(instance==null){
			synchronized(SysMsgWebSocketHandler.class){
				if(instance==null){
					instance=new SysMsgWebSocketHandler();
				}
			}
		}
		return instance;
	}
	private SysMsgWebSocketHandler(){}
