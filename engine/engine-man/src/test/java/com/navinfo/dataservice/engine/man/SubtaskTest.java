...
public class SubtaskTest extends InitApplication{
	...
	public void testPaintRefer() throws Exception {
		...
		String parameter ="{\"id1\":793,\"lineWkt\":\"LINESTRING(86.39374 48.05072,86.40678 48.0603,86.4085 48.06127,86.41631 48.06277,86.42318 48.06242,86.4261 48.06168,86.42627 48.06076,86.42627 48.05789,86.42747 48.05777,86.42756 48.0572,86.4261 48.05525,86.41974 48.05519,86.4188 48.0545,86.41674 48.05416,86.41494 48.05428,86.41391 48.05347,86.41228 48.05296,86.40841 48.0529,86.40661 48.05473,86.40618 48.05651,86.39494 48.0502)\"}"; 
		...
		//String parameter ="{\"id1\":749,\"id2\":754}"; 
		if (StringUtils.isEmpty(parameter)){
			throw new IllegalArgumentException("parameter参数不能为空。");
		}		
		JSONObject dataJson = JSONObject.fromObject(parameter);			
