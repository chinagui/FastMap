...
public class OpRefRdGsc implements IOperation {
	...
	public String run(Result result) throws Exception {
		...
		if (CollectionUtils.isNotEmpty(rdGscList)) {
			com.navinfo.dataservice.engine.edit.operation.obj.rdgsc.update.Operation updateOp = new com.navinfo.dataservice.engine.edit.operation.obj.rdgsc.update.Operation("LC_LINK");
