...
public class LuFaceTopoOperator extends AbstractOperator {

	private static Logger logger = Logger.getLogger(LuFaceTopoOperator.class);
	...
	public void updateRow2Sql(Statement stmt) throws Exception {
		...
		Set<Entry<String, Object>> set = luFaceTopo.changedFields().entrySet();
