...
public class OpRefRelationObj {
	...
	public String handleLaneConnexity(Command command, Result result) throws Exception {
		...
		com.navinfo.dataservice.engine.edit.operation.obj.rdlaneconnexity.depart.Operation operation = new com.navinfo.dataservice.engine.edit.operation.obj.rdlaneconnexity.depart.Operation(
				conn, preNodePid, lastNodePid, command.getNoTargetLinks(), command.getLinks());
	...
	public String handlerdSpeedlimit(Command command, Result result) throws Exception {
		...
		com.navinfo.dataservice.engine.edit.operation.obj.rdspeedlimit.depart.Operation operation = new com.navinfo.dataservice.engine.edit.operation.obj.rdspeedlimit.depart.Operation(
				conn);
		return operation.updownDepart(command.getsNode(), command.getLinks(), command.getLeftLinkMapping(),
	...
	public String handlerRdLinkTmc(Command command, Result result) throws Exception {
		com.navinfo.dataservice.engine.edit.operation.obj.tmc.depart.Operation operation = new com.navinfo.dataservice.engine.edit.operation.obj.tmc.depart.Operation(
				conn);
		return operation.updownDepart(command.getLinks(), command.getLeftLinkMapping(), command.getRightLinkMapping(),
				result);
	}
