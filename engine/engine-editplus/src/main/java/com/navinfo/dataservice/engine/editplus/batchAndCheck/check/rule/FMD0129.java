...
/**
 *  FM-D01-29	POI简称中文名称格式检查		DHM	
	检查条件：
	非删除POI对象；
	检查原则：
	  1、检查POI简称中文名称中“（”与“）”、中括号“［”和“］”、大括号“｛”、“｝”、书名号“《”、“》”应成对出现，（官方别名曾用名中文名称都是全角,如果存在半角，则认为是不成对）报log1：POI中文名称中括号需要成对出现！
 ...
 * @author sunjiawei
 */
public class FMD0129 extends BasicCheckRule {
	@Override
	public void runCheck(BasicObj obj) throws Exception {
		if(obj.objName().equals(ObjectName.IX_POI)){
			...
			for(IxPoiName nameTmp:poiObj.getIxPoiNames()){
				if(nameTmp.isCH()&&nameTmp.isShortName()&&nameTmp.isStandardName()){
