...
public class MsgManJobWebSocketHandler extends TextWebSocketHandler {
	protected static Logger log;
	private static final ArrayList<WebSocketSession> users;
	static {
		users = new ArrayList<WebSocketSession>();
		log = LoggerRepos.getLogger(MsgManJobWebSocketHandler.class);
	}
	private volatile static MsgManJobWebSocketHandler instance;
	public static MsgManJobWebSocketHandler getInstance(){
		if(instance==null){
			synchronized(MsgManJobWebSocketHandler.class){
				if(instance==null){
					instance=new MsgManJobWebSocketHandler();
				}
			}
		}
		return instance;
	}
	private MsgManJobWebSocketHandler(){}
