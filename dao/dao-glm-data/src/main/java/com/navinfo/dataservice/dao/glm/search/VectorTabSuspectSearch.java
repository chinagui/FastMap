...
public class VectorTabSuspectSearch  implements ISearch{
    ...
    public VectorTabSuspectSearch(Connection conn) {
        this.conn = conn;
    }
    ...
    public List<SearchSnapshot> searchDataByTileWithGap(int x, int y, int z, int gap) throws Exception {
        ...
        try {
        	log.info("VectorTabSuspectSearch sql: "+ sql);
			...
			while (resultSet.next()) {
				...
				m.put("c", resultSet.getString("LENGTH"));
