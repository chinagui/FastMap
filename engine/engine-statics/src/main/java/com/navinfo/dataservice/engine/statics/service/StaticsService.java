...
public class StaticsService {
			...
			while (resultSet.next()) {
				if (objTable.equals(resultSet.getString("TB_NM")) && opStatus == 0) {
					...
					if (1 == opStatus || 2 == opStatus) {
						...
						if (isExistsAddHis(objPid, objTable, conn, lastObjOpDate)) {
							return 1;
						} else {
							return opStatus;
						}
	 ...
	 * @throws Exception
	 */
	public boolean isExistsAddHis(int objPid, String objTable, Connection conn, Date lastObjOpDate) throws Exception {
