 ...
 * @date: 2017年10月14日
 * @Desc: FMDPA007.java 检查条件： 非删除点门牌对象 检查原则：
 *        DP_NAME字段不能有繁体字。查找的繁体字在TY_CHARACTER_FJT_HZ中所在行的CONVERT字段的值是2，
 *        则DP_NAME不能是FT对应的值，否则报log：外业门牌号**是繁体字，对应的简体字是**，请修改！
 */
public class FMDPA007 extends BasicCheckRule {
