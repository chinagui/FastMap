...
public class Transaction {
		...
		case RDLINK:
			...
			case REPAIR:
				return new com.navinfo.dataservice.engine.edit.edit.operation.topo.repair.Command(
						json, requester);
			case DEPART:
				return new com.navinfo.dataservice.engine.edit.edit.operation.topo.departnode.Command(
						json, requester);
			}
		case RDNODE:
			switch (operType) {
	...
	private IProcess createProcess(ICommand command) throws Exception {
		...
		case RDLINK:
			...
			case REPAIR:
				return new com.navinfo.dataservice.engine.edit.edit.operation.topo.repair.Process(
						command);
			case DEPART:
				return new com.navinfo.dataservice.engine.edit.edit.operation.topo.departnode.Process(
						command);
			}
		case RDNODE:
			switch (operType) {
		...
		case RDLANECONNEXITY:
			switch (operType) {
			case CREATE:
				return new com.navinfo.dataservice.engine.edit.edit.operation.obj.rdlaneconnexity.create.Process(
						command);
			case UPDATE:
				return new com.navinfo.dataservice.engine.edit.edit.operation.obj.rdlaneconnexity.update.Process(
						command);
			case DELETE:
				return new com.navinfo.dataservice.engine.edit.edit.operation.obj.rdlaneconnexity.delete.Process(
						command);
			}
		case RDSPEEDLIMIT:
			switch (operType) {
		...
		case RDLINKSPEEDLIMIT:
			switch (operType) {
			case CREATE:
				return new com.navinfo.dataservice.engine.edit.edit.operation.obj.rdlink.rdlinkspeedlimit.create.Process(
						command);
			}
		}
