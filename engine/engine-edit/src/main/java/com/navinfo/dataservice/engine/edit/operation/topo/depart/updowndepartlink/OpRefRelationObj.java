...
public class OpRefRelationObj {
    ...
    public String handleRdNode(Command command, Result result) throws Exception {
        com.navinfo.dataservice.engine.edit.operation.obj.rdnode.depart.Operation operation = new com.navinfo.dataservice.engine.edit.operation.obj.rdnode.depart.Operation(conn);
    ...
    public String handleLaneConnexity(Command command, Result result) throws Exception {
        ...
        com.navinfo.dataservice.engine.edit.operation.obj.rdlaneconnexity.depart.Operation operation = new com.navinfo.dataservice.engine.edit.operation.obj.rdlaneconnexity.depart.Operation(conn, preNodePid, lastNodePid, command.getNoTargetLinks(), command.getLinks());
    ...
    public String handleRestriction(Command command, Result result) throws Exception {
        ...
        com.navinfo.dataservice.engine.edit.operation.obj.rdrestriction.depart.Operation operation = new com.navinfo.dataservice.engine.edit.operation.obj.rdrestriction.depart.Operation(conn, preNodePid, lastNodePid, command.getNoTargetLinks(), command.getLinks());
    ...
    public String handleVoiceguide(Command command, Result result) throws Exception {
        ...
        com.navinfo.dataservice.engine.edit.operation.obj.rdvoiceguide.depart.Operation operation = new com.navinfo.dataservice.engine.edit.operation.obj.rdvoiceguide.depart.Operation(conn, preNodePid, lastNodePid, command.getNoTargetLinks(), command.getLinks());
    ...
    public String handleBranch(Command command, Result result) throws Exception {
        ...
        com.navinfo.dataservice.engine.edit.operation.obj.rdbranch.depart.Operation operation = new com.navinfo.dataservice.engine.edit.operation.obj.rdbranch.depart.Operation(conn, preNodePid, lastNodePid, command.getNoTargetLinks(), command.getLinks());
    ...
    public String handleDirectroute(Command command, Result result) throws Exception {
        ...
        com.navinfo.dataservice.engine.edit.operation.obj.rddirectroute.depart.Operation operation = new com.navinfo.dataservice.engine.edit.operation.obj.rddirectroute.depart.Operation(conn, preNodePid, lastNodePid, command.getNoTargetLinks(), command.getLinks());
    ...
    public String handlerRdLane(Command command, Result result) throws Exception {
        com.navinfo.dataservice.engine.edit.operation.obj.rdlane.delete.Operation operation = new com.navinfo.dataservice.engine.edit.operation.obj.rdlane.delete.Operation(conn);
    ...
    public String handlerRdTollgate(Command command, Result result) throws Exception {
        com.navinfo.dataservice.engine.edit.operation.obj.rdtollgate.depart.Operation operation = new com.navinfo.dataservice.engine.edit.operation.obj.rdtollgate.depart.Operation(conn);
        return operation.updownDepart(command.getsNode(), command.getLinks(), command.getLeftLinkMapping(), command.getRightLinkMapping(), command.getNoTargetLinks(), result);
    }
