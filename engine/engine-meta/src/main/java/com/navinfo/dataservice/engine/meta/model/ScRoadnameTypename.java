...
/** 
* @ClassName:  ScRoadnameTypename 
* @author code generator
* @date 2017-03-23 07:06:36 
* @Description: TODO
*/
public class ScRoadnameTypename  {
	...
	public ScRoadnameTypename (){
	}
	
	public ScRoadnameTypename (Integer id ,String name,String py,String englishname,Integer regionFlag,String langCode){
		this.id=id ;
		this.name=name ;
		this.py=py ;
	...
	public String toString() {
		return "ScRoadnameTypename [id=" + id +",name="+name+",py="+py+",englishname="+englishname+",regionFlag="+regionFlag+",langCode="+langCode+"]";
	}
	...
	public boolean equals(Object obj) {
		...
		if (getClass() != obj.getClass())
			return false;
		ScRoadnameTypename other = (ScRoadnameTypename) obj;
		if (id == null) {
			if (other.id != null)
				return false;
