...
public class Transaction {
	...
	private AbstractCommand createCommand() throws Exception {
		...
		case RDCROSS:
			...
			case DELETE:
				return new com.navinfo.dataservice.engine.edit.operation.topo.delete.deletecross.Command(
						json, requester);
			case BATCH:
				return new com.navinfo.dataservice.engine.edit.operation.topo.batch.batchrdcross.Command(
						json, requester);
			}
		case RDBRANCH:
			switch (operType) {
		...
		case ADADMIN:
			...
			case MOVE:
				return new com.navinfo.dataservice.engine.edit.operation.obj.adadmin.move.Command(
						json, requester);
			case RELATION:
				return new com.navinfo.dataservice.engine.edit.operation.obj.adadmin.relation.Command(
						json, requester);
			}
		case RDGSC:
			switch (operType) {
		...
		case RDHGWGLIMIT:
			switch (operType) {
			case CREATE:
				return new com.navinfo.dataservice.engine.edit.operation.obj.hgwg.create.Command(
						json, requester);
			case UPDATE:
				return new com.navinfo.dataservice.engine.edit.operation.obj.hgwg.update.Command(
						json, requester);
			case MOVE:
				return new com.navinfo.dataservice.engine.edit.operation.obj.hgwg.move.Command(
						json, requester);
			case DELETE:
				return new com.navinfo.dataservice.engine.edit.operation.obj.hgwg.delete.Command(
						json, requester);
			default:
				break;
			}
		case RDMILEAGEPILE:
			switch (operType) {
			case CREATE:
				return new com.navinfo.dataservice.engine.edit.operation.obj.mileagepile.create.Command(
						json, requester);
			case UPDATE:
				return new com.navinfo.dataservice.engine.edit.operation.obj.mileagepile.update.Command(
						json, requester);
			case MOVE:
				return new com.navinfo.dataservice.engine.edit.operation.obj.mileagepile.move.Command(
						json, requester);
			case DELETE:
				return new com.navinfo.dataservice.engine.edit.operation.obj.mileagepile.delete.Command(
						json, requester);
			default:
				break;
			}
		case RDTMCLOCATION:
			switch (operType) {
			case CREATE:
				return new com.navinfo.dataservice.engine.edit.operation.obj.tmc.create.Command(
						json, requester);
			case UPDATE:
				return new com.navinfo.dataservice.engine.edit.operation.obj.tmc.update.Command(
						json, requester);
			case DELETE:
				return new com.navinfo.dataservice.engine.edit.operation.obj.tmc.delete.Command(
						json, requester);
			default:
				break;
			}
	...
	private AbstractProcess createProcess(AbstractCommand command)
		...
		case RDCROSS:
			...
			case DELETE:
				return new com.navinfo.dataservice.engine.edit.operation.topo.delete.deletecross.Process(
						command);
			case BATCH:
				return new com.navinfo.dataservice.engine.edit.operation.topo.batch.batchrdcross.Process(
						command);
			}
		case RDBRANCH:
			switch (operType) {
		...
		case ADADMIN:
			...
			case MOVE:
				return new com.navinfo.dataservice.engine.edit.operation.obj.adadmin.move.Process(
						command);
			case RELATION:
				return new com.navinfo.dataservice.engine.edit.operation.obj.adadmin.relation.Process(
						command);
			}
		case RDGSC:
			switch (operType) {
		...
		case RDHGWGLIMIT:
			switch (operType) {
			case CREATE:
				return new com.navinfo.dataservice.engine.edit.operation.obj.hgwg.create.Process(
						command);
			case UPDATE:
				return new com.navinfo.dataservice.engine.edit.operation.obj.hgwg.update.Process(
						command);
			case MOVE:
				return new com.navinfo.dataservice.engine.edit.operation.obj.hgwg.move.Process(
						command);
			case DELETE:
				return new com.navinfo.dataservice.engine.edit.operation.obj.hgwg.delete.Process(
						command);
			default:
				break;
			}
		case RDMILEAGEPILE:
			switch (operType) {
			case CREATE:
				return new com.navinfo.dataservice.engine.edit.operation.obj.mileagepile.create.Process(
						command);
			case UPDATE:
				return new com.navinfo.dataservice.engine.edit.operation.obj.mileagepile.update.Process(
						command);
			case MOVE:
				return new com.navinfo.dataservice.engine.edit.operation.obj.mileagepile.move.Process(
						command);
			case DELETE:
				return new com.navinfo.dataservice.engine.edit.operation.obj.mileagepile.delete.Process(
						command);
			default:
				break;
			}
		case RDTMCLOCATION:
			switch (operType) {
			case CREATE:
				return new com.navinfo.dataservice.engine.edit.operation.obj.tmc.create.Process(
						command);
			case UPDATE:
				return new com.navinfo.dataservice.engine.edit.operation.obj.tmc.update.Process(
						command);
			case DELETE:
				return new com.navinfo.dataservice.engine.edit.operation.obj.tmc.delete.Process(
						command);
			default:
				break;
			}
