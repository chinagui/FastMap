...
/** 
 * @ClassName: InfoPoiMultiSrcDayImportor
 * @author zl
 * @date 2017年11月1日
 * @Description: InfoPoiMultiSrcDayImportor.java
 */
public class InfoPoiMultiSrcDayImportor extends AbstractOperation {
	...
	public InfoPoiMultiSrcDayImportor(Connection conn,OperationResult preResult) {
	...
	public void operate(AbstractCommand cmd) throws Exception {
		MultiSrcUploadPois pois = ((InfoPoiMultiSrcDayImportorCommand)cmd).getPois();
		this.dbId= ((InfoPoiMultiSrcDayImportorCommand)cmd).getDbId();
...
//					sourceTypes.put(poi.objPid(), sourceProvider);
	...
	public String getName() {
		...
		return "InfoPoiMultiSrcDayImportor";
	}
