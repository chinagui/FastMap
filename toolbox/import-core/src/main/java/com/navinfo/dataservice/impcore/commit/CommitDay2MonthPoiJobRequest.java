 ...
 * 
 */
public class CommitDay2MonthPoiJobRequest extends AbstractJobRequest {
	...
	public CommitDay2MonthPoiJobRequest() {
		super();
		log = LoggerRepos.getLogger(log);
	}
	public CommitDay2MonthPoiJobRequest(JSONObject jsonConfig) {
		super();
		log = LoggerRepos.getLogger(log);
