...
/**
 *  FM-D01-103 		F-3官方标准英文出入口翻译检查
	检查条件：
	非删除POI对象
	检查原则：
	1）官方标准化中文名中包含“口”且不包含“入”和“出”，官方标准化英文名中包含“exit”或“entrance”且不包含“exit/entrance”时，报log：出入口翻译错误！
	2）官方标准化中文名中包含“出入口”，官方标准化英文名中不包含“exit/entrance”时，报log：出入口翻译错误！
	官方标准中文名称（name_type=1，name_class=1，lang_Code=CHI或CHT）；
	官方标准英文名称（name_type=1，name_class=1，lang_Code=ENG）
 * @author sunjiawei
 */
public class FMD01103 extends BasicCheckRule {
	...
	public void runCheck(BasicObj obj) throws Exception {
		if(obj.objName().equals(ObjectName.IX_POI)){
			...
			IxPoiName engName=poiObj.getOfficeStandardEngName();
