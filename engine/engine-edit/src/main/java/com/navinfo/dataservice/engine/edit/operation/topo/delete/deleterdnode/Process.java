...
public class Process extends AbstractProcess<Command> {
    ...
    public void lockRdCross() throws Exception {
        ...
        List<RdCross> crosses = selector.loadRdCrossByNodeOrLink(this.getCommand().getNodePids(), this.getCommand().getLinkPids(), true);
    ...
    private Map<String, List<AlertObject>> confirmRelationObj() throws Exception {
        ...
        // link
        com.navinfo.dataservice.engine.edit.operation.topo.delete.deleterdlink.OpTopo opTopo = new com.navinfo.dataservice.engine.edit
                .operation.topo.delete.deleterdlink.OpTopo(null);
        ...
        delRdLaneConAlertDataList.addAll(rdLaneConOperation.getDeleteRdLaneConnexityInfectData(this.getCommand().getLinkPids()));
        ...
        updateRdInterAlertDataList.addAll(rdInterOperation.getUpdateRdInterInfectData(this.getCommand().getLinkPids(), this.getCommand()
                .getNodePids(), conn));
        delRdInterAlertDataList.addAll(rdInterOperation.getDeleteRdInterInfectData(this.getCommand().getLinkPids(), this.getCommand()
                .getNodePids(), conn));
        ...
        sameNodeAlertDataList.addAll(sameNodeOperation.getDeleteLinkSameNodeInfectData(this.getCommand().getNodePids(), "RD_NODE", conn));
        ...
        com.navinfo.dataservice.engine.edit.operation.obj.poi.delete.Operation poiOperation = new com.navinfo.dataservice.engine.edit.operation.obj.poi.delete.Operation(conn);
        for (RdLink link : links) {
            int linkPid = link.getPid();
        ...
        com.navinfo.dataservice.engine.edit.operation.obj.rddirectroute.delete.Operation routerOperation = new com.navinfo.dataservice.engine.edit.operation.obj.rddirectroute.delete.Operation(conn);
        for (RdLink link : links) {
            int linkPid = link.getPid();
