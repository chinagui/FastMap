...
public class RdHgwgLimitSearch implements ISearch {
    ...
    public List<SearchSnapshot> searchDataByTileWithGap(int x, int y, int z, int gap) throws Exception {
        ...
        String sql = "select a.pid, a.geometry point_geom, b.geometry link_geom, a.direct from rd_hgwg_limit a, " +
                "rd_link b where sdo_relate(a.geometry, sdo_geometry(:1, 8307), 'mask=anyinteract') = 'TRUE' and a" +
                ".u_record != 2 and a.link_pid != 0 and a.link_pid = b.link_pid union all select a.pid, a.geometry "
                + "point_geom, null link_geom, a.direct from rd_hgwg_limit a where sdo_relate(a.geometry, " +
                "sdo_geometry" + "(:2, 8307), 'mask=anyinteract') = 'TRUE' and a.u_record != 2 and a.link_pid = 0\n";
