		...
		case RDCROSS:
			...
			case UPDATE:
				return new com.navinfo.dataservice.engine.edit.operation.obj.rdcross.update.Command(
						json, requester);
			case DELETE:
				return new com.navinfo.dataservice.engine.edit.operation.obj.rdcross.delete.Command(
						json, requester);
			}
		case RDBRANCH:
			switch (operType) {
		...
		case RDCROSS:
			...
			case UPDATE:
				return new com.navinfo.dataservice.engine.edit.operation.obj.rdcross.update.Process(
						command);
			case DELETE:
				return new com.navinfo.dataservice.engine.edit.operation.obj.rdcross.delete.Process(
						command);
			}
		case RDBRANCH:
			switch (operType) {
