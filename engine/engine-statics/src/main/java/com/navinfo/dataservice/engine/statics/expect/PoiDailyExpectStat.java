...
public class PoiDailyExpectStat implements Runnable {
	...
	public PoiDailyExpectStat(CountDownLatch cdl, List<BlockMan> blocks,
	...
	private Map<String, Integer> getBlockStat(String blockId) {
		...
		MongoCursor<Document> iter = md.find(PoiDailyMain.col_name_block,
