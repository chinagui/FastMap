...
public class GridUtils {
	...
	public static String location2Grid(double x, double y) {
		String meshId = MeshUtils.location2Mesh(MeshUtils.decimal2Second(x), MeshUtils.decimal2Second(y));
	...
	public static String[] getEnclosingRectangle(JSONArray grids){
		...
		String startRowkey = GeoHash.geoHashStringWithCharacterPrecision(minLat, minLon,12);
		
		String stopRowkey = GeoHash.geoHashStringWithCharacterPrecision(maxLat, maxLon,12);
	...
	public static void main(String[] args) {
		...
		String[] str = getEnclosingRectangle(JSONArray.fromObject(new String[]{"59567201"}));
		
		for(String s : str){
			System.out.println(s);
		}
		
		System.out.println(GeoHash.geoHashStringWithCharacterPrecision(39,116 ,12));
		
		System.out.println(GeoHash.geoHashStringWithCharacterPrecision(39,117 ,12));
		
		System.out.println(GeoHash.geoHashStringWithCharacterPrecision(40,117 ,12));
		
		System.out.println(GeoHash.geoHashStringWithCharacterPrecision(40,116 ,12));
