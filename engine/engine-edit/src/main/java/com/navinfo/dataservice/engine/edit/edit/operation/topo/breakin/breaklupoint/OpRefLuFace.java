...
public class OpRefLuFace implements IOperation {
	...
	private void handleLuFaceTopo() throws Exception {
		...
		for (LuFace face : command.getFaces()) {
			...
			links.add(command.getsLuLink());
			links.add(command.geteLuLink());
			com.navinfo.dataservice.engine.edit.edit.operation.obj.luface.create.Operation opFace = new com.navinfo.dataservice.engine.edit.edit.operation.obj.luface.create.Operation(result, face);
