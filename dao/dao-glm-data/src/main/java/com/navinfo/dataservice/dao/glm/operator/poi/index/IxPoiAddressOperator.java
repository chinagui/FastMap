 ...
 * 
 */
public class IxPoiAddressOperator extends AbstractOperator {
	...
	public void insertRow2Sql(Statement stmt) throws Exception {
		...
		sb.append("(NAME_ID, NAME_GROUPID, POI_PID, LANG_CODE, SRC_FLAG, FULLNAME, FULLNAME_PHONETIC, ROADNAME, ROADNAME_PHONETIC, ADDRNAME, "
	...
	public void updateRow2Sql(Statement stmt) throws Exception {
		StringBuilder sb = new StringBuilder("update "
				+ ixPoiAddress.tableName() + " set u_record=3,u_date='"
				+ StringUtils.getCurrentTime() + "',");

		Set<Entry<String, Object>> set = ixPoiAddress.changedFields()
				.entrySet();
	...
	public void deleteRow2Sql(Statement stmt) throws Exception {
		String sql = "update " + ixPoiAddress.tableName()
