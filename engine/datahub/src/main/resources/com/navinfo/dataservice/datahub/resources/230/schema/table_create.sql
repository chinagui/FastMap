...
create table IX_POI_CHARGINGPLOT  (
   ...
   "MODE"               NUMBER(2)                      default 0
       check ("MODE" is null or ("MODE" in (0,1))) disable,
   MEMO                 VARCHAR2(500),
   U_RECORD             NUMBER(2)                      default 0 not null
       check (U_RECORD in (0,1,2,3)) disable,
   U_FIELDS             VARCHAR2(1000),
...
(
   ...
   MEMO                 VARCHAR2(100),
   MAIN_POI_PID         NUMBER(10)                     not null,
   U_RECORD             NUMBER(2)            default 0 not null
check (U_RECORD in (0,1,2,3)) disable ,
   U_FIELDS             VARCHAR2(1000),
...
create table RD_ELECTRONICEYE  (
   ...
   KIND                 NUMBER(2)                      default 0 not null
       check (KIND in (0,1,2,3,10,11,12,13,14,15,16,98)) disable,
   ANGLE                NUMBER(8,5)                    default 0 not null,
...
create table PARK_IX_POI  (
   ...
   PMESH_ID             NUMBER(6)                      default 0 not null,
   MESH_ID              NUMBER(6)                      default 0 not null,
   FACE_PID             NUMBER(10)                     default 0 not null,
   POI_PID_FLOOR        NUMBER(10)                      not null,
   FLOOR_LEVEL          VARCHAR2(2),
   SERVICE_TYPE         NUMBER(10)                     default 0 not null,
   EDIT_FLAG            NUMBER(1)                      default 1 not null
       check (EDIT_FLAG in (0,1)) disable,
   U_RECORD             NUMBER(2)                      default 0 not null
       check (U_RECORD in (0,1,2,3)) disable,
   U_FIELDS             VARCHAR2(1000),
   constraint PK_PARK_IX_POI primary key (PID)
);

/*==============================================================*/
/* Table: PARK_IX_POI_NAME                                      */
/*==============================================================*/
create table PARK_IX_POI_NAME  (
   NAME_ID              NUMBER(10)                      not null,
   NAME_GROUPID         NUMBER(10)                     default 1 not null,
   POI_PID              NUMBER(10)                      not null,
   LANG_CODE            VARCHAR2(3)                    default 'CHI' not null
   ...
   U_RECORD             NUMBER(2)                      default 0 not null
       check (U_RECORD in (0,1,2,3)) disable,
   U_FIELDS             VARCHAR2(1000),
   constraint PK_PARK_IX_POI_NAME primary key (NAME_ID),
   constraint PARK_IXPOI_NAME foreign key (POI_PID)
         references PARK_IX_POI (PID) disable
);

/*==============================================================*/
/* Table: PARK_IX_POI_ADDRESS                                   */
/*==============================================================*/
create table PARK_IX_POI_ADDRESS  (
   NAME_ID              NUMBER(10)                      not null,
   POI_PID              NUMBER(10)                      not null,
   NAME_GROUPID         NUMBER(10)                     default 1 not null,
   LANG_CODE            VARCHAR2(3)                    default 'CHI' not null
   ...
   U_RECORD             NUMBER(2)                      default 0 not null
       check (U_RECORD in (0,1,2,3)) disable,
   U_FIELDS             VARCHAR2(1000),
   constraint PK_PARK_IX_POI_ADDRESS primary key (NAME_ID),
   constraint PARK_IXPOI_ADDRESS foreign key (POI_PID)
         references PARK_IX_POI (PID) disable
);

/*==============================================================*/
/* Table: PARK_IX_POI_CONTACT                                   */
/*==============================================================*/
create table PARK_IX_POI_CONTACT  (
   POI_PID              NUMBER(10)                      not null,
   CONTACT_TYPE         NUMBER(2)                      default 1 not null
       check (CONTACT_TYPE in (1,2,3,4,11,21,22)) disable,
   CONTACT              VARCHAR2(128),
   ...
   U_RECORD             NUMBER(2)                      default 0 not null
       check (U_RECORD in (0,1,2,3)) disable,
   U_FIELDS             VARCHAR2(1000),
   constraint PARK_IXPOI_CONTACT foreign key (POI_PID)
         references PARK_IX_POI (PID) disable
);

/*==============================================================*/
/* Table: PARK_IX_POI_PARENT                                    */
/*==============================================================*/
create table PARK_IX_POI_PARENT  (
   GROUP_ID             NUMBER(10)                      not null,
   PARENT_POI_PID       NUMBER(10)                      not null,
   U_RECORD             NUMBER(2)                      default 0 not null
       check (U_RECORD in (0,1,2,3)) disable,
   U_FIELDS             VARCHAR2(1000),
   constraint PK_PARK_IX_POI_PARENT primary key (GROUP_ID)
);

/*==============================================================*/
/* Table: PARK_IX_POI_CHILDREN                                  */
/*==============================================================*/
create table PARK_IX_POI_CHILDREN  (
   GROUP_ID             NUMBER(10)                      not null,
   CHILD_POI_PID        NUMBER(10)                      not null,
   RELATION_TYPE        NUMBER(1)                      default 0 not null
       check (RELATION_TYPE in (0,1,2)) disable,
   U_RECORD             NUMBER(2)                      default 0 not null
       check (U_RECORD in (0,1,2,3)) disable,
   U_FIELDS             VARCHAR2(1000),
   constraint PARK_IXPOI_PARENT_CHILD foreign key (GROUP_ID)
         references PARK_IX_POI_PARENT (GROUP_ID) disable,
   constraint PARK_IXPOI_CHILD foreign key (CHILD_POI_PID)
         references PARK_IX_POI (PID) disable
);
...
create table PARK_RD_NODE  (
   ...
   U_RECORD             NUMBER(2)                      default 0 not null
       check (U_RECORD in (0,1,2,3)) disable,
   U_FIELDS             VARCHAR2(1000),
   constraint PK_PARK_RD_NODE primary key (NODE_PID),
   constraint FK_PARK_RDNODE_POI foreign key (POI_PID_FLOOR)
         references PARK_IX_POI (PID) disable
);
...
/* Table: PARK_RD_LINK                                          */
/*==============================================================*/
create table PARK_RD_LINK  (
   LINK_PID             NUMBER(10)                      not null,
   KIND                 NUMBER(2)                      default 8 not null
       check (KIND in (8,10)) disable,
   S_NODE_PID           NUMBER(10)                      not null,
   E_NODE_PID           NUMBER(10)                      not null,
   DIRECT               NUMBER(1)                      default 1 not null
       check (DIRECT in (0,1,2,3)) disable,
   ...
   MESH_ID              NUMBER(6)                      default 0 not null,
   LANE_NUM             NUMBER(2)                      default 2 not null,
   PEDES_ALLOWED        NUMBER(1)                      default 1 not null
       check (PEDES_ALLOWED in (0,1)) disable,
   POI_PID_FLOOR        NUMBER(10)                      not null,
   EDIT_FLAG            NUMBER(1)                      default 1 not null
       check (EDIT_FLAG in (0,1)) disable,
   U_RECORD             NUMBER(2)                      default 0 not null
       check (U_RECORD in (0,1,2,3)) disable,
   U_FIELDS             VARCHAR2(1000),
   constraint PK_PARK_RD_LINK primary key (LINK_PID),
   constraint PARK_RDLINK_NODE_S foreign key (S_NODE_PID)
         references PARK_RD_NODE (NODE_PID) disable,
   constraint PARK_RDLINK_NODE_E foreign key (E_NODE_PID)
         references PARK_RD_NODE (NODE_PID) disable,
   constraint FK_PARK_RDLINK_POI foreign key (POI_PID_FLOOR)
         references PARK_IX_POI (PID) disable
);


/*==============================================================*/
/* Table: PARK_RD_LINK_FORM                                     */
/*==============================================================*/
create table PARK_RD_LINK_FORM  (
   LINK_PID             NUMBER(10)                      not null,
   FORM_OF_WAY          NUMBER(2)                      default 1 not null
       check (FORM_OF_WAY in (1,83,84,85)) disable,
   U_RECORD             NUMBER(2)                      default 0 not null
       check (U_RECORD in (0,1,2,3)) disable,
   U_FIELDS             VARCHAR2(1000),
   constraint PARK_RDLINK_FORM foreign key (LINK_PID)
         references PARK_RD_LINK (LINK_PID) disable
);


/*==============================================================*/
/* Table: PARK_RD_NODE_MESH                                     */
/*==============================================================*/
create table PARK_RD_NODE_MESH  (
   NODE_PID             NUMBER(10)                      not null,
   MESH_ID              NUMBER(6)                      default 0 not null,
   U_RECORD             NUMBER(2)                      default 0 not null
       check (U_RECORD in (0,1,2,3)) disable,
   U_FIELDS             VARCHAR2(1000),
   constraint PARK_RDNODE_MESH foreign key (NODE_PID)
         references PARK_RD_NODE (NODE_PID) disable
);

/*==============================================================*/
/* Table: PARK_RD_NODE_FORM                                     */
/*==============================================================*/
create table PARK_RD_NODE_FORM  (
   NODE_PID             NUMBER(10)                      not null,
   FORM_OF_WAY          NUMBER(2)                      default 1 not null
       check (FORM_OF_WAY in (1,2,44,45)) disable,
   U_RECORD             NUMBER(2)                      default 0 not null
       check (U_RECORD in (0,1,2,3)) disable,
   U_FIELDS             VARCHAR2(1000),
   constraint PARK_RDNODE_FORM foreign key (NODE_PID)
         references PARK_RD_NODE (NODE_PID) disable
);
...
create table PARK_RD_SLOPE  (
   ...
   U_RECORD             NUMBER(2)                      default 0 not null
       check (U_RECORD in (0,1,2,3)) disable,
   U_FIELDS             VARCHAR2(1000),
   constraint PK_PARK_RD_SLOPE primary key (PID),
   constraint PARK_RDSLOPE_LINK foreign key (LINK_PID)
         references PARK_RD_LINK (LINK_PID) disable,
   constraint PARK_RDSLOPE_NODE foreign key (NODE_PID)
         references PARK_RD_NODE (NODE_PID) disable
);
...
/* Table: PARK_RD_GSC                                           */
/*==============================================================*/
create table PARK_RD_GSC  (
   PID                  NUMBER(10)                      not null,
   GEOMETRY             SDO_GEOMETRY,
   U_RECORD             NUMBER(2)                      default 0 not null
       check (U_RECORD in (0,1,2,3)) disable,
   U_FIELDS             VARCHAR2(1000),
   constraint PK_PARK_RD_GSC primary key (PID)
);

/*==============================================================*/
/* Table: PARK_RD_GSC_LINK                                      */
/*==============================================================*/
create table PARK_RD_GSC_LINK  (
   PID                  NUMBER(10)                      not null,
   ZLEVEL               NUMBER(2)                      default 0 not null,
   LINK_PID             NUMBER(10)                     default 0 not null,
   TABLE_NAME           VARCHAR2(64),
   ...
   U_RECORD             NUMBER(2)                      default 0 not null
       check (U_RECORD in (0,1,2,3)) disable,
   U_FIELDS             VARCHAR2(1000),
   constraint PARK_RDGSC_LINK foreign key (PID)
         references PARK_RD_GSC (PID) disable
);

/*==============================================================*/
/* Table: PARK_LU_FACE                                          */
/*==============================================================*/
create table PARK_LU_FACE  (
   FACE_PID             NUMBER(10)                      not null,
   FEATURE_PID          NUMBER(10)                     default 0 not null,
   GEOMETRY             SDO_GEOMETRY,
   KIND                 NUMBER(2)                      default 0 not null
       check (KIND in (0,42,43,44,45)) disable,
   COLOR                VARCHAR2(10),
   POI_PID_FLOOR        NUMBER(10)                      not null,
   MESH_ID              NUMBER(6)                      default 0 not null,
   EDIT_FLAG            NUMBER(1)                      default 1 not null
   ...
   U_RECORD             NUMBER(2)                      default 0 not null
       check (U_RECORD in (0,1,2,3)) disable,
   U_FIELDS             VARCHAR2(1000),
   constraint PK_PARK_LU_FACE primary key (FACE_PID),
   constraint FK_PARK_LUFACE_POI foreign key (POI_PID_FLOOR)
         references PARK_IX_POI (PID) disable
);
...
create table PARK_LU_NODE  (
   ...
   U_RECORD             NUMBER(2)                      default 0 not null
       check (U_RECORD in (0,1,2,3)) disable,
   U_FIELDS             VARCHAR2(1000),
   constraint PK_PARK_LU_NODE primary key (NODE_PID)
);

/*==============================================================*/
/* Table: PARK_LU_LINK                                          */
/*==============================================================*/
create table PARK_LU_LINK  (
   LINK_PID             NUMBER(10)                      not null,
   S_NODE_PID           NUMBER(10)                      not null,
   E_NODE_PID           NUMBER(10)                      not null,
   GEOMETRY             SDO_GEOMETRY,
   ...
   U_RECORD             NUMBER(2)                      default 0 not null
       check (U_RECORD in (0,1,2,3)) disable,
   U_FIELDS             VARCHAR2(1000),
   constraint PK_PARK_LU_LINK primary key (LINK_PID),
   constraint PARK_LULINK_SNODE foreign key (S_NODE_PID)
         references PARK_LU_NODE (NODE_PID) disable,
   constraint PARK_LULINK_ENODE foreign key (E_NODE_PID)
         references PARK_LU_NODE (NODE_PID) disable
);
...
/*==============================================================*/
/* Table: PARK_LU_FACE_TOPO                                     */
/*==============================================================*/
create table PARK_LU_FACE_TOPO  (
   FACE_PID             NUMBER(10)                      not null,
   SEQ_NUM              NUMBER(3)                      default 1 not null,
   LINK_PID             NUMBER(10)                      not null,
   U_RECORD             NUMBER(2)                      default 0 not null
       check (U_RECORD in (0,1,2,3)) disable,
   U_FIELDS             VARCHAR2(1000),
   constraint PARK_LUFACE_LINK foreign key (LINK_PID)
         references PARK_LU_LINK (LINK_PID) disable,
   constraint PARK_LUFACE_LINKS foreign key (FACE_PID)
         references PARK_LU_FACE (FACE_PID) disable
);


/*==============================================================*/
/* Table: PARK_LU_LINK_MESH                                     */
/*==============================================================*/
create table PARK_LU_LINK_MESH  (
   LINK_PID             NUMBER(10)                      not null,
   MESH_ID              NUMBER(6)                      default 0 not null,
   U_RECORD             NUMBER(2)                      default 0 not null
       check (U_RECORD in (0,1,2,3)) disable,
   U_FIELDS             VARCHAR2(1000),
   constraint PARK_LULINK_MESH foreign key (LINK_PID)
         references PARK_LU_LINK (LINK_PID) disable
);

/*==============================================================*/
/* Table: PARK_LU_LINK_KIND                                     */
/*==============================================================*/
create table PARK_LU_LINK_KIND  (
   LINK_PID             NUMBER(10)                      not null,
   KIND                 NUMBER(2)                      default 0 not null
       check (KIND in (0,42,43,44,45)) disable,
   U_RECORD             NUMBER(2)                      default 0 not null
       check (U_RECORD in (0,1,2,3)) disable,
   U_FIELDS             VARCHAR2(1000),
   constraint PARK_LULINK_KIND foreign key (LINK_PID)
         references PARK_LU_LINK (LINK_PID) disable
);

/*==============================================================*/
/* Table: PARK_LU_NODE_MESH                                     */
/*==============================================================*/
create table PARK_LU_NODE_MESH  (
   NODE_PID             NUMBER(10)                      not null,
   MESH_ID              NUMBER(6)                      default 0 not null,
   U_RECORD             NUMBER(2)                      default 0 not null
       check (U_RECORD in (0,1,2,3)) disable,
   U_FIELDS             VARCHAR2(1000),
   constraint PARK_LUNODE_MESH foreign key (NODE_PID)
         references PARK_LU_NODE (NODE_PID) disable
);

/*==============================================================*/
/* Table: PARK_LU_FEATURE                                       */
/*==============================================================*/
create table PARK_LU_FEATURE  (
   FEATURE_PID          NUMBER(10)                      not null,
   U_RECORD             NUMBER(2)                      default 0 not null
       check (U_RECORD in (0,1,2,3)) disable,
   U_FIELDS             VARCHAR2(1000),
   constraint PK_PARK_LU_FEATURE primary key (FEATURE_PID)
);
