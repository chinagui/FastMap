...
public class Day2MonPoiLogByTaskIdSelector extends DefaultLogSelector{
	private Logger log = LoggerRepos.getLogger(this.getClass());
	private Date startTime;
	public Day2MonPoiLogByTaskIdSelector(OracleSchema logSchema,Date stopTime,List<Integer> grids,List<Integer> taskIds,int taskType) {
		super(logSchema);
	...
	public Day2MonPoiLogByTaskIdSelector(OracleSchema logSchema) {
		super(logSchema);
	}
	/**
...
//				"               and s3.poi_pid = t3.pid))\r\n") ;
		...
		sb.append("delete from "+tempTable+" l\r\n" + 
				...
				if(taskIds!=null&&taskIds.size()>0){
					...
					sb.append("   and "+str+" in ("+StringUtils.join(taskIds, ",")+") \r\n") ;
				}
