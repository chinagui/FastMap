...
CREATE TABLE POI_EDIT_STATUS(
  ...
  CONSTRAINT FK_POI_EDIT_STATUS_1 FOREIGN KEY(ROW_ID)
      REFERENCES IX_POI (ROW_ID) DISABLE,
...
CREATE TABLE POI_DEEP_STATUS(
  ...
  TYPE NUMBER(1) DEFAULT 1 NOT NULL,
  STATUS NUMBER(1) DEFAULT 1,
  CONSTRAINT FK_POI_DEEP_STATUS_1 FOREIGN KEY(ROW_ID)
      REFERENCES IX_POI (ROW_ID) DISABLE,
  CONSTRAINT PK_POI_EDIT_STATUS PRIMARY KEY(ROW_ID,TYPE)
);
CREATE TABLE POI_DEEP_WORKITEM(
  ...
  CONSTRAINT FK_POI_DEEP_WKITEM_1 FOREIGN KEY(ROW_ID)
      REFERENCES IX_POI (ROW_ID) DISABLE
);
...
create table LOG_OPERATION (
    ...
    RELEASE_STA NUMBER(1) DEFAULT 0 NOT NULL
	    CHECK(RELEASE_STA IN (0,1)) DIABLE,
