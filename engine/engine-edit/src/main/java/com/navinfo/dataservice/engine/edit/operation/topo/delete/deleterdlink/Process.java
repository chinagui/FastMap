...
public class Process extends AbstractProcess<Command> {
    ...
    private Map<String, List<AlertObject>> confirmRelationObj() throws Exception {
        ...
        // 行政区划代表点
        com.navinfo.dataservice.engine.edit.operation.obj.adadmin.update.Operation adadminOperation = new com.navinfo.dataservice.engine
                .edit.operation.obj.adadmin.update.Operation(null, null);
        ...
        // node
        List<AlertObject> nodeAlertDataList = opTopo.getDeleteNodeInfectData(linkPid, conn, this.getCommand().getNodes());
        if (CollectionUtils.isNotEmpty(nodeAlertDataList)) {
            infects.put("删除Node", nodeAlertDataList);
        }

        // 交限
        com.navinfo.dataservice.engine.edit.operation.obj.rdrestriction.delete.Operation rdrestrictionOperation = new com.navinfo
                .dataservice.engine.edit.operation.obj.rdrestriction.delete.Operation(conn);
        ...
        com.navinfo.dataservice.engine.edit.operation.obj.rdlaneconnexity.delete.Operation rdLaneConOperation = new com.navinfo
                .dataservice.engine.edit.operation.obj.rdlaneconnexity.delete.Operation(conn);
        ...
        // 分歧
        com.navinfo.dataservice.engine.edit.operation.obj.rdbranch.delete.Operation rdBranchOperation = new com.navinfo.dataservice
                .engine.edit.operation.obj.rdbranch.delete.Operation(null, null, null);
        ...
        List<AlertObject> delOutRdBranchAlertDataList = rdBranchOperation.getDeleteBOutLinkranchInfectData(linkPid, conn);
        if (CollectionUtils.isNotEmpty(delOutRdBranchAlertDataList)) {
            infects.put("删除link作为退出线的分歧信息", delOutRdBranchAlertDataList);
        }
        List<AlertObject> delViaRdBranchAlertDataList = rdBranchOperation.getDeleteBViaLinkranchInfectData(linkPid, conn);
        if (CollectionUtils.isNotEmpty(delViaRdBranchAlertDataList)) {
            infects.put("删除link作为经过线的分歧信息", delViaRdBranchAlertDataList);
        }

        // 路口
        com.navinfo.dataservice.engine.edit.operation.topo.delete.deletecross.OpTopo rdCrossOperation = new com.navinfo.dataservice
                .engine.edit.operation.topo.delete.deletecross.OpTopo(null, null);
        ...
        // 立交
        com.navinfo.dataservice.engine.edit.operation.obj.rdgsc.delete.Operation rdGscOperation = new com.navinfo.dataservice.engine
                .edit.operation.obj.rdgsc.delete.Operation(conn);
        ...
        // 限速关系
        com.navinfo.dataservice.engine.edit.operation.obj.rdspeedlimit.delete.Operation rdSpeedLimitOperation = new com.navinfo
                .dataservice.engine.edit.operation.obj.rdspeedlimit.delete.Operation(null, null);
        List<AlertObject> updateSpeedLimitAlertDataList = rdSpeedLimitOperation.getUpdateRdSpeedLimitInfectData(linkPid, conn);
        if (CollectionUtils.isNotEmpty(updateSpeedLimitAlertDataList)) {
            infects.put("删除link维护限速关系", updateSpeedLimitAlertDataList);
        }
        // 电子眼
        com.navinfo.dataservice.engine.edit.operation.obj.rdeleceye.delete.Operation rdEyeOperation = new com.navinfo.dataservice.engine
                .edit.operation.obj.rdeleceye.delete.Operation(conn);
        ...
        // 大门
        com.navinfo.dataservice.engine.edit.operation.obj.rdgate.delete.Operation rdGateOperation = new com.navinfo.dataservice.engine
                .edit.operation.obj.rdgate.delete.Operation(conn);
        ...
        // CRF交叉点
        com.navinfo.dataservice.engine.edit.operation.obj.rdinter.delete.Operation rdInterOperation = new com.navinfo.dataservice.engine
                .edit.operation.obj.rdinter.delete.Operation(conn);
        List<AlertObject> updateRdInterAlertDataList = rdInterOperation.getUpdateRdInterInfectData(linkPidList, this.getCommand()
                .getNodePids(), conn);
        if (CollectionUtils.isNotEmpty(updateRdInterAlertDataList)) {
            infects.put("删除link维护CRF交叉点", updateRdInterAlertDataList);
        }
        List<AlertObject> delRdInterAlertDataList = rdInterOperation.getDeleteRdInterInfectData(linkPidList, this.getCommand()
                .getNodePids(), conn);
        if (CollectionUtils.isNotEmpty(delRdInterAlertDataList)) {
            infects.put("删除link删除CRF交叉点", delRdInterAlertDataList);
        }
        // CRF Road
        com.navinfo.dataservice.engine.edit.operation.obj.rdroad.delete.Operation rdRoadOperation = new com.navinfo.dataservice.engine
                .edit.operation.obj.rdroad.delete.Operation(conn);
        ...
        // 详细车道
        com.navinfo.dataservice.engine.edit.operation.obj.rdlane.delete.Operation rdLaneOperation = new com.navinfo.dataservice.engine
                .edit.operation.obj.rdlane.delete.Operation(conn);
        ...
        // 同一点
        com.navinfo.dataservice.engine.edit.operation.obj.rdsamenode.delete.Operation sameNodeOperation = new com.navinfo.dataservice
                .engine.edit.operation.obj.rdsamenode.delete.Operation(conn);
        List<AlertObject> sameNodeAlertDataList = sameNodeOperation.getDeleteLinkSameNodeInfectData(this.getCommand().getNodePids(),
                "RD_NODE", conn);
        ...
        // 同一线
        com.navinfo.dataservice.engine.edit.operation.obj.rdsamelink.delete.Operation sameLinkOperation = new com.navinfo.dataservice
                .engine.edit.operation.obj.rdsamelink.delete.Operation(conn);
        ...
        // 分叉口提示
        com.navinfo.dataservice.engine.edit.operation.obj.rdse.delete.Operation rdSeOperation = new com.navinfo.dataservice.engine.edit
                .operation.obj.rdse.delete.Operation(conn);
        ...
        // 坡度
        com.navinfo.dataservice.engine.edit.operation.obj.rdslope.delete.Operation rdSlopOperation = new com.navinfo.dataservice.engine
                .edit.operation.obj.rdslope.delete.Operation(conn);
        ...
        // 减速带
        com.navinfo.dataservice.engine.edit.operation.obj.rdspeedbump.delete.Operation rdSpeedbumpOperation = new com.navinfo
                .dataservice.engine.edit.operation.obj.rdspeedbump.delete.Operation(conn);
        ...
        // 收费站
        com.navinfo.dataservice.engine.edit.operation.obj.rdtollgate.delete.Operation rdTollgateOperation = new com.navinfo.dataservice
                .engine.edit.operation.obj.rdtollgate.delete.Operation(conn);
        ...
        // 可变限速
        com.navinfo.dataservice.engine.edit.operation.obj.rdvariablespeed.delete.Operation rdVariableOperation = new com.navinfo
                .dataservice.engine.edit.operation.obj.rdvariablespeed.delete.Operation(conn);
        ...
        List<AlertObject> rdVariableUpdateAlertDataList = rdVariableOperation.getUpdateRdVariableInfectData(linkPid, conn);
        ...
        // poi被动维护
        com.navinfo.dataservice.engine.edit.operation.obj.poi.delete.Operation poiOperation = new com.navinfo.dataservice.engine.edit
                .operation.obj.poi.delete.Operation(conn);
        ...
        // 顺行
        com.navinfo.dataservice.engine.edit.operation.obj.rddirectroute.delete.Operation routerOperation = new com.navinfo.dataservice
                .engine.edit.operation.obj.rddirectroute.delete.Operation(conn);
        ...
        com.navinfo.dataservice.engine.edit.operation.obj.tmc.update.Operation rdinterOperation = new com.navinfo.dataservice.engine.edit.operation.obj.tmc.update.Operation(this.getConn());
        List<RdLink> linkObjList = new ArrayList<>();
        linkObjList.add(link);
        List<AlertObject> tmcAlertObject = rdinterOperation.getDeleteInfectRdTmc(linkObjList, linkPidList);
