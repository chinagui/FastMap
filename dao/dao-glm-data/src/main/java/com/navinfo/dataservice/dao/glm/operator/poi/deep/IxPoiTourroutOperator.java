...
public class IxPoiTourroutOperator implements IOperator {
	...
	public void updateRow() throws Exception {
		StringBuilder sb = new StringBuilder("update " + ixPoiTourroute.tableName()
				+ " set u_record=3,");
		...
		try {
			...
			Set<Entry<String, Object>> set = ixPoiTourroute.changedFields().entrySet();
	...
	public void insertRow2Sql(Statement stmt) throws Exception {
		...
		sb.append("(tour_id, tour_name, tour_name_eng, tour_intr, tour_intr_eng, tour_type, tour_type_eng, tour_x, tour_y, tour_len, trail_time, visit_time, poi_pid, reserved, memo, u_record, row_id) values (");
	...
	public void deleteRow2Sql(Statement stmt) throws Exception {
		String sql = "update " + ixPoiTourroute.tableName() + " set u_record=2 where   tour_id      =" + ixPoiTourroute.getPid();
		stmt.addBatch(sql);
	}
