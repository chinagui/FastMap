...
values ('129', 'poi_deep', 'deepDetail', 'FM-TEMP-1', 1, 2);

insert into poi_column_workitem_conf (ID, FIRST_WORK_ITEM, SECOND_WORK_ITEM, WORK_ITEM_ID, TYPE, CHECK_FLAG)
values ('130', 'poi_deep', 'deepDetail', 'FM-TEMP-2', 2, 0);

insert into poi_column_workitem_conf (ID, FIRST_WORK_ITEM, SECOND_WORK_ITEM, WORK_ITEM_ID, TYPE, CHECK_FLAG)
values ('131', 'poi_deep', 'deepDetail', 'FM-TEMP-3', 1, 2);

insert into poi_column_workitem_conf (ID, FIRST_WORK_ITEM, SECOND_WORK_ITEM, WORK_ITEM_ID, TYPE, CHECK_FLAG)
values ('132', 'poi_deep', 'deepParking', 'FM-TEMP-4', 2, 0);

insert into poi_column_workitem_conf (ID, FIRST_WORK_ITEM, SECOND_WORK_ITEM, WORK_ITEM_ID, TYPE, CHECK_FLAG)
values ('133', 'poi_deep', 'deepParking', 'FM-TEMP-5', 1, 2);

insert into poi_column_workitem_conf (ID, FIRST_WORK_ITEM, SECOND_WORK_ITEM, WORK_ITEM_ID, TYPE, CHECK_FLAG)
values ('134', 'poi_deep', 'deepParking', 'FM-TEMP-6', 2, 0);

insert into poi_column_workitem_conf (ID, FIRST_WORK_ITEM, SECOND_WORK_ITEM, WORK_ITEM_ID, TYPE, CHECK_FLAG)
values ('135', 'poi_deep', 'deepParking', 'FM-TEMP-7', 2, 0);

insert into poi_column_workitem_conf (ID, FIRST_WORK_ITEM, SECOND_WORK_ITEM, WORK_ITEM_ID, TYPE, CHECK_FLAG)
values ('136', 'poi_deep', 'deepParking', 'FM-TEMP-8', 1, 2);

insert into poi_column_workitem_conf (ID, FIRST_WORK_ITEM, SECOND_WORK_ITEM, WORK_ITEM_ID, TYPE, CHECK_FLAG)
values ('137', 'poi_deep', 'deepCarrental', 'FM-TEMP-9', 1, 2);

insert into poi_column_workitem_conf (ID, FIRST_WORK_ITEM, SECOND_WORK_ITEM, WORK_ITEM_ID, TYPE, CHECK_FLAG)
values ('138', 'poi_deep', 'deepCarrental', 'FM-TEMP-10', 2, 0);

insert into poi_column_workitem_conf (ID, FIRST_WORK_ITEM, SECOND_WORK_ITEM, WORK_ITEM_ID, TYPE, CHECK_FLAG)
values ('139', 'poi_deep', 'deepCarrental', 'FM-TEMP-11', 1, 2);

insert into poi_column_workitem_conf (ID, FIRST_WORK_ITEM, SECOND_WORK_ITEM, WORK_ITEM_ID, TYPE, CHECK_FLAG)
values ('140', 'poi_deep', 'deepCarrental', 'FM-TEMP-12', 2, 0);

insert into poi_column_workitem_conf (ID, FIRST_WORK_ITEM, SECOND_WORK_ITEM, WORK_ITEM_ID, TYPE, CHECK_FLAG)
values ('141', 'poi_deep', 'deepCarrental', 'FM-TEMP-13', 1, 2);

insert into poi_column_workitem_conf (ID, FIRST_WORK_ITEM, SECOND_WORK_ITEM, WORK_ITEM_ID, TYPE, CHECK_FLAG)
values ('142', 'poi_deep', 'deepCarrental', 'FM-TEMP-14', 2, 0);
COMMIT;
