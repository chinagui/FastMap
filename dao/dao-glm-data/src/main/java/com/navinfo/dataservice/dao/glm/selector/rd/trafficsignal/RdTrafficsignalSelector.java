...
//		}
     ...
     * @throws Exception
     */
    public RdTrafficsignal loadByNodeAndLinkPid(Integer nodePid, Integer linkPid, boolean isLock) throws Exception {
        RdTrafficsignal row = null;
        StringBuilder sb = new StringBuilder(
                "select * from rd_trafficsignal where node_pid = :1 and link_pid = :2 and u_record !=2");
        if (isLock) {
            sb.append(" for update nowait");
        }
        PreparedStatement pstmt = null;
