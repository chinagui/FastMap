...
public class ZoneNodeSearch implements ISearch {
	...
	public List<IRow> searchDataByPids(List<Integer> pidList) throws Exception {
		...
		ZoneNodeSelector selector = new ZoneNodeSelector(conn);
