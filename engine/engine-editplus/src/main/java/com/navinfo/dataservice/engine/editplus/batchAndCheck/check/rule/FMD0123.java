...
/**
 * FM-D01-23	简称别名中文繁体字检查	 D	
 * 检查条件：
 * 非删除POI对象
 * 检查原则：
 * 简称中文名称不能有繁体字。查找的繁体字在TY_CHARACTER_FJT_HZ中所在行的CONVERT字段的值：
 * 1、如果是2表示必须转化，报log：**是繁体字，对应的简体字是**，必须转化
 * 检查名称：标准化中文名称（name_type=1，name_class={5}，langCode=CHI）
 * 
 * @author gaopengrong
 *
 */
public class FMD0123 extends BasicCheckRule {
