...
public class PoiDailyMain {
	...
	public static final String col_name_grid = "fm_stat_daily_poi_grid";
	public static final String col_name_block = "fm_stat_daily_poi_block";
	public static final String col_name_city = "fm_stat_daily_poi_city";
