...
CREATE TABLE TEMP_RD_SPEEDLIMIT_TRUCK_${suffix} (PID  NUMBER(10)) NOLOGGING;
...
CREATE TABLE TEMP_FILTER_IX_POINTADDR_${suffix} (PID  NUMBER(10)) NOLOGGING;
...
--20160111 250模型升级
CREATE TABLE TEMP_RD_MILEAGEPILE_${suffix} (PID  NUMBER(10)) NOLOGGING;
--20161101 限高限重导出原则修改，按照图幅导出
CREATE TABLE TEMP_RD_HGWG_LIMIT_${suffix} (PID  NUMBER(10)) NOLOGGING;
--20170620 280 限宽限高导出原则修改，按照图幅导出
CREATE TABLE TEMP_RD_LANE_HGWD_${suffix} (PID  NUMBER(10)) NOLOGGING;
--20170620 280 RD_LINK_WARNING原则修改，按照图幅导出
CREATE TABLE TEMP_RD_LINK_WARNING_${suffix} (PID  NUMBER(10)) NOLOGGING;