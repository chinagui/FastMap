...
public class Operation implements IOperation {
    ...
    //                point = (Point) GeoTranslator.transform(GeoTranslator.point2Jts(obj.getDouble("longitude"),
    ...
    //    this.updateNodeForLink(nodePid, node);
    //
    //}
    //
    ///***
    ...
    // * @throws Exception
    // */
    //private void departCatchtNode(Result result, int nodePid, int catchNodePid, CmgBuildnode preNode, List<CmgBuildlink> links)
    //        throws Exception {
    //    CmgBuildnodeSelector nodeSelector = new CmgBuildnodeSelector(conn);
    ...
    //    // 组装更新node的参数
    //    // 保证是同一个连接
    //    com.navinfo.dataservice.engine.edit.operation.obj.cmg.node.update.Command updatecommand =
    //            new com.navinfo.dataservice.engine.edit.operation.obj.cmg.node.update.Command(updateContent, command.getRequester(), node);
    //    com.navinfo.dataservice.engine.edit.operation.obj.cmg.node.update.Process process =
    //            new com.navinfo.dataservice.engine.edit.operation.obj.cmg.node.update.Process(updatecommand, result, conn);
    //    process.innerRun();
    //}
    ///***
    // * 重新赋值link的起始点的pid
