...
import com.navinfo.dataservice.dao.glm.model.render.MissRoadTengXun;
...
public class MissRoadTengXunSearch  implements ISearch{
    ...
    public MissRoadTengXunSearch(Connection conn) {
        this.conn = conn;
    }
    ...
    public IObj searchDataByPid(int pid) throws Exception {
        return (IObj) new AbstractSelector(MissRoadTengXun.class, conn).loadById(pid, false);
    }
	...
	List<SearchSnapshot> list = new ArrayList<>();
	        ...
	        try {
	        	log.info("MISS_ROAD_TENGXUN Search sql : "+sql);
