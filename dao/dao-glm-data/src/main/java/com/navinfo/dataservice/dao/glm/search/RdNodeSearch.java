			...
			while (resultSet.next()) {
				...
				for (int i = 0; i < linkPids.split(",").length; i++) {
					...
					if (linkJSON != null) {
						...
						linkJSON.put("kinds", resultSet.getString("kinds").split(",")[i]);
