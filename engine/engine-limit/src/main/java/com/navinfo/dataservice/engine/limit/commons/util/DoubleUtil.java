...
public class DoubleUtil {
	...
	public static double keepSpecDecimal(Double data,int num){
		return (double)(Math.round(data*Math.pow(10,num))/(Math.pow(10,num)+0.0));
	} 
	...
	public static void main(String[] args){
		System.out.println(keepSpecDecimal(1.23456666,4));
