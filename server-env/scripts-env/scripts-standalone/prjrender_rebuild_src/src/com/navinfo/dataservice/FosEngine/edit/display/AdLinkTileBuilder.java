...
public class AdLinkTileBuilder {
	...
	public static class TileMapper extends
		...
		protected void map(LongWritable key, Text value, Context context)
			...
			String sql = "select a.link_pid,   a.s_node_pid,   a.e_node_pid,   sdo_util.to_wktgeometry(a.geometry) geometry   from ad_link a    where a.u_record != 2 and mod(a.link_pid,"+taskNum+")="
					+ mod;
		...
		public void writeLine(String wktLine, int linkPid, Context context,
				Text keyText, Text valueText, byte degree, int sNodePid,
				int eNodePid) throws Exception {
	...
	public static void run(Configuration conf,String tabPrefix) throws Exception {
		...
		String tabName = (StringUtils.isEmpty(tabPrefix)?"":tabPrefix+"_")+"ADLINK_" + conf.get("dbId");
		...
		int numTask = Integer.valueOf(conf.get("adlinkTaskNum"));
