...
/**
 * FM-D01-20	POI简称中文名称非法字符检查	DHM	
 * 检查条件：
 * 非删除POI对象；
 * 检查原则：
 * 简称中文名称允许存在“TY_CHARACTER_EGALCHAR_EXT”表，“EXTENTION_TYPE”字段中“GBK”、“ENG_F_U”、“ENG_F_L”、“DIGIT_F”、“SYMBOL_F”类型对应的“CHARACTER”字段的内容，如果存在其他字符，将此条POI报出。
 * 报log：POI中文名称非法字符检查：POI中文名中含有非法字符“xx”
 * 检查名称：简称中文名称（name_type=1，name_class={5}，langCode=CHI或CHT）

 * @author gaopengrong
 *
 */
public class FMD0120 extends BasicCheckRule {
	...
	public void runCheck(BasicObj obj) throws Exception {
		if(obj.objName().equals(ObjectName.IX_POI)){
			...
			for(IxPoiName nameTmp:poiObj.getIxPoiNames()){
				if(nameTmp.isCH()&&nameTmp.getNameType()==1&&nameTmp.getNameClass()==5){
