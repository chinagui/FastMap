...
public class LuFaceSearch implements ISearch {

	private Connection conn;

	public LuFaceSearch(Connection conn) {
		this.conn = conn;
	}
	...
	public IObj searchDataByPid(int pid) throws Exception {
		...
		IObj luFace = (IObj) luFaceSelector.loadById(pid, false);
	...
	public static void main(String[] args) throws Exception {
		...
		LuFaceSearch s = new LuFaceSearch(conn);
