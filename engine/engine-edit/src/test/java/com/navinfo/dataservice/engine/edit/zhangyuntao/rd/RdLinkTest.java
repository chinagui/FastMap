...
public class RdLinkTest extends InitApplication {
    ...
    public void repair() {
        String parameter = "{\"command\":\"REPAIR\",\"dbId\":42,\"objId\":100008849," +
                ...
                "" + "" + "" + "" + "" + "\"type\":\"RDLINK\"}";
        parameter = "{\"command\":\"REPAIR\",\"objId\":88026139,\"type\":\"RDLINK\"," +
                "\"data\":{\"geometry\":{\"type\":\"LineString\",\"coordinates\":[[116.5,39.91115],[116.498550004163," +
                "39.911177748268145],[116.49846,39.91118]]},\"interLinks\":[],\"interNodes\":[]},\"dbId\":84}";
        TestUtil.run(parameter);
    }
    ...
    public void updownDepart() {
        ...
        parameter = "{\"command\":\"UPDOWNDEPART\",\"type\":\"RDLINK\",\"dbId\":84,\"distance\":6.6," +
                "\"data\":{\"linkPids\":[420000010]}}";
        TestUtil.run(parameter);
    }
