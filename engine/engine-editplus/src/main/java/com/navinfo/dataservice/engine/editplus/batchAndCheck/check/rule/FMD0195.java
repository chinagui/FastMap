...
/**
 *  FM-D01-95	F-1官方标准英文称存在首字母小写	DHM
	检查条件：
	非删除POI对象
	检查原则：
	官方标准英文名中存在" a"," b"," c"," d"," e"," f"," g"," h"," i"," j"," k"," l"," m"," n"," o"," p"," q"," r"," s"," t"," u"," v"," w"," x"," y"," z"开头的单词时，报log：英文名中***（按实际单词报）首字母小写！
	备注：
	1、如果单词本身为如下单词则不报错
 ...
 * @author sunjiawei
 */
public class FMD0195 extends BasicCheckRule {
