...
/**
 * FM-D01-11   简称作业  简称中文名称错别字检查   D	
 * 检查条件：
 * 非删除POI对象
 * 检查原则：
 * 简称中文名称如果包含SC_POINT_NAMECK中“TYPE”=4且HM_FLAG<>’HM’对应的pre_key的值，则存在错别字，报log：名称中**是错别字，正确应为**。
 * (SC_POINT_NAMECK中“TYPE”=4且HM_FLAG<>’HM’对应的pre_key为错别字，result_key为正确字)
 * 标准化中文名称（name_type=1，name_class=5，langCode=CHI）
 * @author gaopengrong
 *
 */
public class FMD0111 extends BasicCheckRule {
