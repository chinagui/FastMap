 ...
 * 
 */
public class IxPoiFlagOperator extends AbstractOperator {
	...
	public void insertRow2Sql(Statement stmt) throws Exception {
		...
		sb.append("(POI_PID, FLAG_CODE, U_DATE,U_RECORD, ROW_ID) values (");
	...
	public void updateRow2Sql(Statement stmt) throws Exception {
		StringBuilder sb = new StringBuilder("update " + ixPoiFlag.tableName()
	...
	public void deleteRow2Sql(Statement stmt) throws Exception {
		String sql = "update " + ixPoiFlag.tableName()
				+ " set u_record=2,u_date= '" + StringUtils.getCurrentTime()
				+ "' where row_id=hextoraw('" + ixPoiFlag.rowId() + "')";
