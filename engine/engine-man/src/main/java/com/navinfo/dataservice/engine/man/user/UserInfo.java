...
public class UserInfo  {
	...
	public UserInfo (Integer userId ,String userRealName,String userNickName,String userPassword,String userEmail,String userPhone,Integer userLevel,Integer userScore,Object userIcon){
		this.userId=userId ;
	...
	public String toString() {
		return "UserInfo [userId=" + userId +",userRealName="+userRealName+",userNickName="+userNickName+",userPassword="+userPassword+",userEmail="+userEmail+",userPhone="+userPhone+",userLevel="+userLevel+",userScore="+userScore+",userIcon="+userIcon+"]";
	}
