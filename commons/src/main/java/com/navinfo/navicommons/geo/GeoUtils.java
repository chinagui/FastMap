...
public abstract class GeoUtils {
	...
	public static void main(String[] args) {
		System.out.println(location2Mesh(117.16816, 40.07542));
		//int meshid = 595673;
		...
		/* System.out.println("=================================================="
		 ...
		 String[] allMesh = get9NeighborMesh("595673");
...
//		 }
		 ...
		 * System.out.println("=================================================="
		 * );
		 * allMesh = area2Meshes(418725, 143550, 419625, 144150);
		 * for (int i = 0; i < allMesh.length; i++) {
		 * String s = allMesh[i];
		 * System.out.println("mesh" + (i + 1) + ":" + s);
		 * }
		 */
		/*int a[] = mesh2Location("595651");
		for (int m : a) {

			// System.out.println(m); ;
			System.out.println(second2Decimal(m));
			;
		}
		String wkt = mesh2WKT("595651");
	...
	/**
	 * 
	 * @param meshIds：已半角逗号分隔开的图符号序列，如"595661,595662"
	 ...
	 * @author XXW
	 */
	private static boolean isExistsInMeshSet(String targetMesh,Set<String> meshSet){
		for(String mesh:meshSet){
