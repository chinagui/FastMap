...
public class LuNodeMeshOperator implements IOperator {
	...
	public void updateRow() throws Exception {
		StringBuilder sb = new StringBuilder("update " + luNodeMesh.tableName() + " set u_record=3,");
	...
	public void deleteRow2Sql(Statement stmt) throws Exception {
		String sql = "update " + luNodeMesh.tableName() + " set u_record=2 where row_id=hextoraw('" + luNodeMesh.rowId()
				+ "')";
