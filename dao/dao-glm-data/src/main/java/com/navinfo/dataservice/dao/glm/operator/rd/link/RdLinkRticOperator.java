...
public class RdLinkRticOperator extends AbstractOperator {

	private static Logger logger = Logger.getLogger(RdLinkRticOperator.class);
	...
	public void deleteRow2Sql(Statement stmt) throws Exception {
		String sql = "update rd_link_rtic set u_record=2 where row_id = hextoraw('"
				+ rtic.getRowId() + "')";
