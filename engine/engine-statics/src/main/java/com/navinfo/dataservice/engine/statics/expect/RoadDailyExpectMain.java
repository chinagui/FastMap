...
public class RoadDailyExpectMain {
	private Logger log = LogManager.getLogger(RoadDailyExpectMain.class);

	private static CountDownLatch countDownLatch = null;

	public static final String col_name_block = "fm_stat_expect_daily_road_block";

	private String db_name;
	private String stat_date;
	private String stat_time;

	public RoadDailyExpectMain(String dbn, String stat_time) {
		this.db_name = dbn;
	...
	public void runStat() {
		...
		try {
			...
			executorService.submit(new RoadDailyExpectStat(countDownLatch,
