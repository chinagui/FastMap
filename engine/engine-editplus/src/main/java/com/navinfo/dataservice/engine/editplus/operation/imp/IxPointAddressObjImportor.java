...
/**
 * @Title:IxPointAddressObjImportor
 * @Package:com.navinfo.dataservice.engine.editplus.operation.imp
 * @Description: 
 * @author:Jarvis 
 * @date: 2017年9月27日
...
public class IxPointAddressObjImportor extends AbstractOperation{
	...
	public IxPointAddressObjImportor(Connection conn, OperationResult preResult) {
	...
	public List<BasicObj> importUpdateByJson(Connection conn,Map<Long, JSONObject> updateMap,String objType) throws Exception {
		...
		if("IXPOI".equals(objType)){
			...
			newObjType = ObjectName.AD_NODE;
		}else if("IXPOINTADDRESS".equals(objType)){
			newObjType = ObjectName.IX_POINTADDRESS;
		}
	...
	public String getObjType(String type) throws Exception{
		...
		if("IXPOI".equals(type)){
			...
			objType = ObjectName.IX_POINTADDRESS;
		}else{
