...
public class RdSignasreal implements IObj {
	...
	public String getSvgfileCode() {
		return svgfileCode;
	}

	public void setSvgfileCode(String svgfileCode) {
		this.svgfileCode = svgfileCode;
	}
