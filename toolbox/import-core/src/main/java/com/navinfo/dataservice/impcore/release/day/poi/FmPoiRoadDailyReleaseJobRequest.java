 ...
 */
public class FmPoiRoadDailyReleaseJobRequest extends AbstractJobRequest {

	private String featureType;//参考LogFlusher.FEATURE_POI
	private int produceId;
	private int regionId;
	private int produceFlag;
	/* (non-Javadoc)
	...
	public int getProduceFlag() {
		return produceFlag;
	}

	public void setProduceFlag(int flag) {
		produceFlag = flag;
	}
