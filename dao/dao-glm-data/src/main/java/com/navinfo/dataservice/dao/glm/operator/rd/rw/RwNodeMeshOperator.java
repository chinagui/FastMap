 ...
 * 
 */
public class RwNodeMeshOperator extends AbstractOperator {
	...
	public void updateRow2Sql(Statement stmt) throws Exception {
		StringBuilder sb = new StringBuilder("update " + rwNodeMesh.tableName()
				+ " set u_record=3,");
	...
	public void deleteRow2Sql(Statement stmt) throws Exception {
		String sql = "update " + rwNodeMesh.tableName()
