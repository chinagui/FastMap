...
public class RdTollgateTest extends InitApplication {
	...
	public void update() {
        ...
        parameter = "{\"command\":\"UPDATE\",\"type\":\"RDTOLLGATE\",\"dbId\":17,\"data\":{\"passages\":[{\"vehicle\":7,\"rowId\":\"C60DEB0726274A05933A1F0EFE89219F\",\"pid\":100034814,\"objStatus\":\"UPDATE\"}],\"rowId\":\"398CB320F2CA4B098A037EA62EBF4095\",\"pid\":100034814}}";
		TestUtil.run(parameter);
	}
