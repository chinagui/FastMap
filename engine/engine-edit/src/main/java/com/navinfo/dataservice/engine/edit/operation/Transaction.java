...
public class Transaction {
	...
	private AbstractCommand createCommand() throws Exception {
		...
		case RDLINKSPEEDLIMIT:
			...
			case CREATE:
				return new com.navinfo.dataservice.engine.edit.operation.obj.rdlink.rdlinkspeedlimit.create.Command(
						json, requester);
			case BATCH:
				return new com.navinfo.dataservice.engine.edit.operation.topo.batch.batchrdlinkspeedlimit.Command(json,
						requester);
			default:
				break;
			}
		...
		case RDVARIABLESPEED:
			switch (operType) {
			case CREATE:
				return new com.navinfo.dataservice.engine.edit.operation.obj.rdvariablespeed.create.Command(json,
						requester);
			case DELETE:
				return new com.navinfo.dataservice.engine.edit.operation.obj.rdvariablespeed.delete.Command(json,
						requester);
			case UPDATE:
				return new com.navinfo.dataservice.engine.edit.operation.obj.rdvariablespeed.update.Command(json,
						requester);
			default:
				break;
			}
		...
		case RDVOICEGUIDE:
			switch (operType) {
			case CREATE:
				return new com.navinfo.dataservice.engine.edit.operation.obj.rdvoiceguide.create.Command(json,
						requester);
			case UPDATE:
				return new com.navinfo.dataservice.engine.edit.operation.obj.rdvoiceguide.update.Command(json,
						requester);
			case DELETE:
				return new com.navinfo.dataservice.engine.edit.operation.obj.rdvoiceguide.delete.Command(json,
						requester);
			default:
				break;
			}
		...
		case RDLANETOPODETAIL:
			switch (operType) {
			case BATCH:
				return new com.navinfo.dataservice.engine.edit.operation.topo.batch.batchrdlanetopodetail.Command(json,
						requester);
			default:
				break;
			}
