package com.navinfo.dataservice.engine.limit.commons.mercator;
...
public final class MercatorProjection {
	 ...
	 */
	public static double[] tileBounds(long tileX, long tileY, byte zoom) {

		double minLonX = tileXToLongitude(tileX, zoom);

		double maxLonY = tileYToLatitude(tileY, zoom);

		double maxLonX = tileXToLongitude(tileX + 1, zoom);

		double minLonY = tileYToLatitude(tileY + 1, zoom);

		return new double[] { minLonX, minLonY, maxLonX, maxLonY };
	}
	 ...
	 * @return wkt
	 */
	public static String tile2Wkt(long tileX, long tileY, byte zoom) {

		double[] bounds = tileBounds(tileX, tileY, zoom);
	...
	public static String getWktWithGap(int x, int y, int z, int gap) {
		...
		double lngMin = pixelXToLongitude(pixXMin, (byte) z);

		// 获取左下角
		double pixYMin = tileYToPixelY(y+1);

		pixYMin = pixYMin + gap;

		double latMin = pixelYToLatitude(pixYMin, (byte) z);

		// 获取右上角X像素坐标
		double pixXMax = tileXToPixelX(x + 1);

		pixXMax = pixXMax + gap;

		double lngMax = pixelXToLongitude(pixXMax, (byte) z);

		// 获取右上角
		double pixYMax = tileYToPixelY(y);

		pixYMax = pixYMax - gap;

		double latMax = pixelYToLatitude(pixYMax, (byte) z);
...
//		System.out.println(tileXToPixelX(107943));
//
//		System.out.println(tileXToPixelX(107944));
//
		System.out.println(tileYToPixelY(49613));

		System.out.println(tileYToPixelY(49614));
		
		System.out.println(pixelYToLatitude(tileYToPixelY(49613),(byte)17));
		
		System.out.println(pixelYToLatitude(tileYToPixelY(49614),(byte)17));
		
		System.out.println(pixelYToLatitude(tileYToPixelY(49613),(byte)17));
		
		System.out.println(pixelYToLatitude(tileYToPixelY(49614),(byte)17));
		
		System.out.println(tileYToLatitude(44444, (byte)17));
		
		System.out.println(tileYToLatitude(44445, (byte)17));
//
//		System.out.println(tileYToLatitude(49613, (byte) 17));
//
//		System.out.println(tileYToLatitude(49614, (byte) 17));
		...
		// System.out.println(MercatorProjection.latitudeToPixelY(40.97989806962013,
		// (byte)10));
		//
		// System.out.println(MercatorProjection.latitudeToPixelY(40.99989806962013,
		// (byte)10));
		//
		// System.out.println(MercatorProjection.latitudeToPixelY(40.95989806962013,
		// (byte)10));
		//
		// System.out.println(MercatorProjection.latitudeToTileY(40.97989806962013,
		// (byte)10));
		//
		// System.out.println(MercatorProjection.latitudeToTileY(40.99989806962013,
		// (byte)10));
		//
		// System.out.println(MercatorProjection.latitudeToTileY(40.95989806962013,
		// (byte)10));
		 ...
		 * System.out.println(lon);
		 * 
		 * System.out.println(MercatorProjection.longitudeToTileX(116.79875,
		 * (byte)10));
		 */

		// 116.21672630310059,40.00286504288028

		// System.out.println(MercatorProjection.longitudeToPixelX(116.2167263,
		// (byte) 14));

		// System.out.println(MercatorProjection.pixelXToLongitude(
		// 3451174.9999638754, (byte) 14));
	}
}