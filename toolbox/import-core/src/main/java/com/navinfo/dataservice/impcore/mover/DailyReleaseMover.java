...
* @author gaopengrong
* @date 2017年2月21日 下午4:21:33 
* @Description: TODO
*  
*/
public class DailyReleaseMover extends DefaultLogMover {
	public DailyReleaseMover(OracleSchema logSchema, OracleSchema tarSchema, String tempTable, String tempFailLogTable) {
	...
	public void rollbackMove() throws Exception{
		...
		try{
			...
			run.update(conn, rollbackDayReleaseSql());
		}catch(Exception e){
	...
	private String rollbackDayReleaseSql() {
		return "delete from LOG_DAY_RELEASE  a\r\n" + 
				"      where a.op_id in (select op_id from "+tarTempTable+")";
	}
