...
//        gdbVersion = "270+";
     ...
     * 备份库创建MD5_CLOB函数
     */
    private void createMd5Function() throws Exception {

        Connection conn = DBConnector.getInstance().getConnectionById(bakDbId);

        try {

            PackageExec packageExec = new PackageExec(conn);
            String spatialIndexSql = "/com/navinfo/dataservice/scripts/resources/create_md5clob_function.sql";
