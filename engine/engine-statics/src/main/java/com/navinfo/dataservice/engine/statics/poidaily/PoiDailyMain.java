...
public class PoiDailyMain {

	private static Logger log = null;
	private static CountDownLatch countDownLatch = null;
	private static final String col_name_grid = "fm_stat_daily_poi_grid";
	private static final String col_name_block = "fm_stat_daily_poi_block";
	private static final String col_name_city = "fm_stat_daily_poi_city";
	...
	public void runStat() {
		...
		try {
			...
			while (iter.hasNext()) {
				...
				executorService.submit(new PoiDailyStat(countDownLatch, db_id, db_name, col_name_grid, stat_date, stat_time));
			}
