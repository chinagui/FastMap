...
/**
 * FM-D01-12   官方标准中文名称中空格错误	DHM	
 * 检查条件：非删除POI对象
 * 检查原则：
 * 1、官方标准化中文名称字段内容中存在空格，且空格前后若为以下组合，将Err的情况，程序报log：名称中存在空格，请检查！；---见空格规则表【备注】sheet页序号=6
 ...
 *
 */
public class FMD0112 extends BasicCheckRule {
