...
/**
 * 	FM-D01-42	POI别名标准中文名称全部为符号检查			DHM	
	检查条件：
	 	非删除POI对象  
	检查原则：
	官方中文别名中，除了全角合法特殊字符（通用元数据库ty_character_egalchar_ext中extention_type 为SYMBOL_F 的记录）外，没有其他字符即全是字符，则报log：名称全部是字符，需要删除设施！
	name_type=1，name_class=3，lang_code=CHI或CHT
 * @author sunjiawei
 *
 */
public class FMD0142 extends BasicCheckRule {
