...
public class Process extends AbstractProcess<Command> {
	...
	public void lockZoneLink() throws Exception {
		...
		List<ZoneLink> links = selector.loadByNodePid(this.getCommand()
				.getNodePid(), true);
	...
	public void lockZoneNode() throws Exception {
		if (this.getCommand().getZoneNode() == null) {
			...
			this.getCommand().setZoneNode(
					(ZoneNode) nodeSelector.loadById(this.getCommand()
							.getNodePid(), true));
		}
	}
	...
	public void lockZoneFace() throws Exception {
		...
		this.getCommand().setFaces(
				faceSelector.loadZoneFaceByNodeId(this.getCommand()
						.getNodePid(), true));
