 ...
 * @ClassName GLM15004
 * @author Han Shaoming
 * @date 2017年1月5日 上午11:36:45
 * @Description TODO
 * 当“内业作业状态”≠2时，做如下检查：限速类型为“普通”时，点限速的“来源”必须是“现场标牌”或“城区标识”，否则报log
 * 点限速限速来源	服务端后检查
 * 点限速限速类型	服务端后检查
 */
public class GLM15004 extends baseRule {
	...
	private boolean check(int pid) throws Exception {
		...
		sb.append(" AND RS.LIMIT_SRC NOT IN (1, 2) AND RS.SPEED_TYPE = 0");
		String sql = sb.toString();
		log.info("后检查GLM15004--sql:" + sql);
