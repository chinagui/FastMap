...
public class RdLinkSelector extends AbstractSelector {
	...
	public List<RdLink> loadInLinkByNodePid(int nodePid, int form, boolean isLock) throws Exception {
		...
		String sql = "SELECT a.* FROM rd_link a inner join RD_LINK_FORM b on a.LINK_PID = b.link_pid and b.FORM_OF_WAY != :1 WHERE a.u_record !=2 and((a.s_node_pid = :2 AND a.direct = 3) OR (a.e_node_pid = :3 AND a.direct = 2) OR (a.direct = 1 AND (a.s_node_pid =:4 OR a.e_node_pid = :5)))";
