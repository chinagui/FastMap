...
public class RdLinkWalkstair implements IRow {
	...
	public int getStairLoc() {
		return stairLoc;
	}

	public void setStairLoc(int stairLoc) {
		this.stairLoc = stairLoc;
	}

	public int getStairFlag() {
		return stairFlag;
	}

	public void setStairFlag(int stairFlag) {
		this.stairFlag = stairFlag;
	}
	...
	public ObjType objType() {
		...
		return ObjType.RDLINKWALKSTAIR;
	}
