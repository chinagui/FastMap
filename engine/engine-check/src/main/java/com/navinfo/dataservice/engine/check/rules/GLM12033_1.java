...
/** 
 * @ClassName: GLM12033_1
 * @author songdongyan
 * @date 2017年3月27日
 * @Description: GLM12033_1.java
 */
public class GLM12033_1 extends baseRule{
	...
	private void checkRdLink(int pid) throws Exception {
		...
		sb.append("    AND RB.RELATIONSHIP_TYPE = 1                                                                                          ");
		...
		sb.append("    AND B.RELATIONSHIP_TYPE = 1                                                                                           ");
		...
		log.info("RdLink GLM12033_1 sql:" + sql);
	...
	private void checkRdBranch(int pid) throws Exception {
		...
		String sql = sb.toString();
		log.info("RdBranchRealimage GLM12033_1 sql:" + sql);
		DatabaseOperator getObj = new DatabaseOperator();
		List<Object> resultList = new ArrayList<Object>();
		resultList = getObj.exeSelect(this.getConn(), sql);
