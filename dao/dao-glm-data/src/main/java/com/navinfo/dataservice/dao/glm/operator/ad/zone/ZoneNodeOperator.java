...
public class ZoneNodeOperator extends AbstractOperator {
	...
	public void insertRow2Sql(Statement stmt) throws Exception {
		...
		for (IRow r : zoneNode.getMeshes()) {
			ZoneNodeMeshOperator ap = new ZoneNodeMeshOperator(conn,
					(ZoneNodeMesh) r);
	...
	public void updateRow2Sql(Statement stmt) throws Exception {
		StringBuilder sb = new StringBuilder("update " + zoneNode.tableName()
				+ " set u_record=3,");
	...
	public void deleteRow2Sql(Statement stmt) throws Exception {
		String sql = "update " + zoneNode.tableName()
				+ " set u_record=2 where node_pid=" + zoneNode.getPid();
