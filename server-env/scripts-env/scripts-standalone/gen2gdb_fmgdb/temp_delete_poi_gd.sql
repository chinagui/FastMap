...
-- CREATE TEMP TABLE
DROP TABLE TEMP_DEL_POI_001;
DROP TABLE TEMP_DEL_POI_PC_001;
DROP TABLE TEMP_DEL_POI_SP_001;
...
-- GATHER STATS
BEGIN  
  PK_TABLE_STATS.gather('TEMP_DEL_POI_001'); 
END;
/
BEGIN  
  PK_TABLE_STATS.gather('TEMP_DEL_POI_PC_001'); 
END;
/
BEGIN  
  PK_TABLE_STATS.gather('TEMP_DEL_POI_SP_001'); 
END;
/
