...
public class TipsOperateTest2 extends InitApplication{
	...
	public void createPreTips() throws Exception {
		...
		try{
		parameter="{\"geometry\":{\"coordinates\":[[116.48153,40.01378],[116.48297,40.01363]],\"type\":\"LineString\"},\"user\":2922,\"sourceType\":\"8001\", \"memo\" :null,\"deep\": {\"fc\":8,\"geo\":null},\"qSubTaskId\":1}";
