...
public class PoiDailyExpectMain {
	private Logger log = LogManager.getLogger(PoiDailyExpectMain.class);

	private static CountDownLatch countDownLatch = null;

	public static final String col_name_block = "fm_stat_expect_daily_poi_block";

	private String db_name;
	private String stat_date;
	private String stat_time;

	public PoiDailyExpectMain(String dbn, String stat_time) {
		this.db_name = dbn;
	...
	public void runStat() {
		...
		try {
			...
			executorService.submit(new PoiDailyExpectStat(countDownLatch, list,
