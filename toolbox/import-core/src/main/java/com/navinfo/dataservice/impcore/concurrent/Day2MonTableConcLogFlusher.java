...
/** 
 * @ClassName: Day2MonConcLogFlusher
 * @author xiaoxiaowen4127
 * @date 2017年9月18日
 * @Description: Day2MonConcLogFlusher.java
 */
public class Day2MonTableConcLogFlusher extends AbstractLogFlusher {

	protected String tableName;
	public Day2MonTableConcLogFlusher(ThreadSharedObjectExtResult sharedResults,String tableName) {
		super(sharedResults);
