...
public class DisplayUtils {
	...
	public static double[] getMid2MPosition(String linkWkt, int direct,double veritUnit) throws Exception {
		...
		position[2] = MercatorProjection.metersXToLongitude(position[0]);

		position[3] = MercatorProjection.metersYToLatitude(position[1]);
		...
		position[0] = MercatorProjection.metersXToLongitude(displayPosition[0]);

		position[1] = MercatorProjection.metersYToLatitude(displayPosition[1]);
	...
	public static void main(String[] args) throws Exception {
		String wkt = "LINESTRING (109.11703 34.26739, 109.11652 34.2678, 109.11618 34.26805, 109.11568 34.26841, 109.11528 34.26867, 109.1147 34.26901, 109.1146 34.26906, 109.11375 34.26953, 109.11323 34.26977, 109.11278 34.26997, 109.11233 34.27017, 109.11134 34.27053, 109.11057 34.2708, 109.11033 34.27088, 109.10918 34.27124, 109.10766 34.27177, 109.10621 34.27231, 109.10593 34.27242, 109.10586 34.27245, 109.10457 34.27296, 109.10455 34.27297, 109.10424 34.2731, 109.1011 34.27444)";
		LineString ls = getGscLine(JtsGeometryFactory.read(wkt), 0, 8);
