 ...
 */
public class DDLExecThreadIgnoreExceptionHandler extends ThreadHandler {
	/**
     *
     */
	...
	public DDLExecThreadIgnoreExceptionHandler(CountDownLatch doneSignal,
			ExpSQL sql,
			DataSource ds,
	...
	public void run() {
		...
		executeIgnoreException(new ExpSqlProcessor() {
