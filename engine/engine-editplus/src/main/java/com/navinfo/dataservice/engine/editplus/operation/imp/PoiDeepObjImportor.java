...
/**
 * @ClassName: PoiDeepObjImportor
 * @author jch
 * @date 下午5:26:53
 * @Description: PoiDeepObjImportor.java
 */

public class PoiDeepObjImportor extends AbstractOperation{
	...
	public PoiDeepObjImportor(Connection conn, OperationResult preResult) {
